...
#define ARM_MPU_RBAR(Region, BaseAddress)                                      \
    (((BaseAddress)&MPU_RBAR_ADDR_Msk) | ((Region)&MPU_RBAR_REGION_Msk) |      \
     (MPU_RBAR_VALID_Msk))
 ...
 */
#define ARM_MPU_RASR_EX(DisableExec, AccessPermission, AccessAttributes,       \
                        SubRegionDisable, Size)                                \
    ((((DisableExec) << MPU_RASR_XN_Pos) & MPU_RASR_XN_Msk) |                  \
     (((AccessPermission) << MPU_RASR_AP_Pos) & MPU_RASR_AP_Msk) |             \
     (((AccessAttributes) & (MPU_RASR_TEX_Msk | MPU_RASR_S_Msk |               \
...
#define ARM_MPU_ACCESS_DEVICE(IsShareable)                                     \
    ((IsShareable) ? ARM_MPU_ACCESS_(0U, 1U, 0U, 1U)                           \
