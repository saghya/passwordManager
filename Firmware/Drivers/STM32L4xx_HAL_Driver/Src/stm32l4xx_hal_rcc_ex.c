...
HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) ==
        ...
        switch (PeriphClkInit->Sai1ClockSelection) {
            case RCC_SAI1CLKSOURCE_PLL: /* PLL is used as clock source for
                                           SAI1*/
            ...
            case RCC_SAI1CLKSOURCE_PLLSAI1: /* PLLSAI1 is used as clock source
                                               for SAI1*/
                /* PLLSAI1 input clock, parameters M, N & P configuration and
                 * clock output (PLLSAI1ClockOut) */
            ...
            case RCC_SAI1CLKSOURCE_PLLSAI2: /* PLLSAI2 is used as clock source
                                               for SAI1*/
                /* PLLSAI2 input clock, parameters M, N & P configuration clock
                 * output (PLLSAI2ClockOut) */
            ...
            case RCC_SAI1CLKSOURCE_PIN: /* External clock is used as source of
                                           SAI1 clock*/
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI2) ==
        ...
        switch (PeriphClkInit->Sai2ClockSelection) {
            case RCC_SAI2CLKSOURCE_PLL: /* PLL is used as clock source for
                                           SAI2*/
                /* Enable SAI Clock output generated from System PLL . */
                __HAL_RCC_PLLCLKOUT_ENABLE(RCC_PLL_SAI3CLK);
                /* SAI2 clock source config set later after clock selection
                 * check */
                break;

            case RCC_SAI2CLKSOURCE_PLLSAI1: /* PLLSAI1 is used as clock source
                                               for SAI2*/
                /* PLLSAI1 input clock, parameters M, N & P configuration and
                 * clock output (PLLSAI1ClockOut) */
                ret = RCCEx_PLLSAI1_Config(&(PeriphClkInit->PLLSAI1),
            ...
            case RCC_SAI2CLKSOURCE_PLLSAI2: /* PLLSAI2 is used as clock source
                                               for SAI2*/
                /* PLLSAI2 input clock, parameters M, N & P configuration and
                 * clock output (PLLSAI2ClockOut) */
                ret = RCCEx_PLLSAI2_Config(&(PeriphClkInit->PLLSAI2),
                                           DIVIDER_P_UPDATE);
                /* SAI2 clock source config set later after clock selection
                 * check */
            ...
            case RCC_SAI2CLKSOURCE_PIN: /* External clock is used as source of
                                           SAI2 clock*/
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) ||    \
    defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) ||    \
    defined(STM32L4S7xx) || defined(STM32L4S9xx)
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_USB) ==
        ...
        if (PeriphClkInit->UsbClockSelection == RCC_USBCLKSOURCE_PLL) {
            ...
            if (PeriphClkInit->UsbClockSelection == RCC_USBCLKSOURCE_PLLSAI1) {
                /* PLLSAI1 input clock, parameters M, N & Q configuration and
                 * clock output (PLLSAI1ClockOut) */
                ret = RCCEx_PLLSAI1_Config(&(PeriphClkInit->PLLSAI1),
                                           DIVIDER_Q_UPDATE);
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SDMMC1) ==
                 ...
                 RCC_SDMMC1CLKSOURCE_PLLP) /* PLL "P" ? */
        {
            ...
            /* PLLSAI1 input clock, parameters M, N & Q configuration and clock
             * output (PLLSAI1ClockOut) */
            ret = RCCEx_PLLSAI1_Config(&(PeriphClkInit->PLLSAI1),
                                       DIVIDER_Q_UPDATE);
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_ADC) ==
        ...
        if (PeriphClkInit->AdcClockSelection == RCC_ADCCLKSOURCE_PLLSAI1) {
            /* PLLSAI1 input clock, parameters M, N & R configuration and clock
             * output (PLLSAI1ClockOut) */
            ret = RCCEx_PLLSAI1_Config(&(PeriphClkInit->PLLSAI1),
                                       DIVIDER_R_UPDATE);
    ...
    defined(STM32L4A6xx)
            ...
            /* PLLSAI2 input clock, parameters M, N & R configuration and clock
             * output (PLLSAI2ClockOut) */
            ret = RCCEx_PLLSAI2_Config(&(PeriphClkInit->PLLSAI2),
                                       DIVIDER_R_UPDATE);
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DSI) ==
        ...
        if (PeriphClkInit->DsiClockSelection == RCC_DSICLKSOURCE_PLLSAI2) {
            /* PLLSAI2 input clock, parameters M, N & Q configuration and clock
             * output (PLLSAI2ClockOut) */
            ret = RCCEx_PLLSAI2_Config(&(PeriphClkInit->PLLSAI2),
                                       DIVIDER_Q_UPDATE);
 ...
 *         USART1, USART2, USART3, UART4, UART5, RTC, ADCx, DFSDMx, SWPMI1, USB,
 * SDMMC1 and RNG).
 * @retval None
 */
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
    ...
    PeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB |
        RCC_PERIPHCLK_SDMMC1 | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_ADC |
        RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_DFSDM1AUDIO | RCC_PERIPHCLK_RTC |
        RCC_PERIPHCLK_OSPI;
    ...
    PeriphClkInit->PLLSAI1.PLLSAI1Source =
        READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC) >> RCC_PLLCFGR_PLLSRC_Pos;
    ...
    if (PeriphClk == RCC_PERIPHCLK_RTC) {
        ...
        switch (PeriphClk) {
            ...
            case RCC_PERIPHCLK_SAI1:
                frequency =
                    RCCEx_GetSAIxPeriphCLKFreq(RCC_PERIPHCLK_SAI1, pllvco);
                break;
            ...
            case RCC_PERIPHCLK_SAI2:
                frequency =
                    RCCEx_GetSAIxPeriphCLKFreq(RCC_PERIPHCLK_SAI2, pllvco);
                break;
                                   ...
                                   RCC_CCIPR2_SDMMCSEL)) /* PLL "P" ? */
                {
                    if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY)) {
                        if (HAL_IS_BIT_SET(RCC->PLLCFGR, RCC_PLLCFGR_PLLPEN)) {
                            ...
                            if (pllp == 0U) {
                                if (READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLP) !=
                                    0U) {
                                    pllp = 17U;
                                } else {
                                    pllp = 7U;
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLSAI1(RCC_PLLSAI1InitTypeDef *PLLSAI1Init)
{
    ...
    if (status == HAL_OK) {
        ...
        __HAL_RCC_PLLSAI1_CONFIG(PLLSAI1Init->PLLSAI1M, PLLSAI1Init->PLLSAI1N,
                                 PLLSAI1Init->PLLSAI1P, PLLSAI1Init->PLLSAI1Q,
                                 PLLSAI1Init->PLLSAI1R);
#else
        /* Configure the PLLSAI1 Multiplication factor N */
        /* Configure the PLLSAI1 Division factors P, Q and R */
        __HAL_RCC_PLLSAI1_CONFIG(PLLSAI1Init->PLLSAI1N, PLLSAI1Init->PLLSAI1P,
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLSAI2(RCC_PLLSAI2InitTypeDef *PLLSAI2Init)
{
    ...
    if (status == HAL_OK) {
        ...
        __HAL_RCC_PLLSAI2_CONFIG(PLLSAI2Init->PLLSAI2N, PLLSAI2Init->PLLSAI2P,
 ...
 *         with HAL_RCC_OscConfig() and the LSE oscillator clock is to be
 ...
 *         contains the configuration parameters N & P & optionally M as well as
 * PLLSAI1 output clock(s)
                                              ...
                                              uint32_t                Divider)
{
    ...
    if (__HAL_RCC_GET_PLL_OSCSOURCE() != RCC_PLLSOURCE_NONE) {
        /* PLL clock source and divider M already set, check that no request for
         * change  */
        ...
        if (status == HAL_OK) {
            ...
            MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM,
                       PllSai1->PLLSAI1Source | (PllSai1->PLLSAI1M - 1U)
                                                    << RCC_PLLCFGR_PLLM_Pos);
#endif
        }
    }
    ...
    if (status == HAL_OK) {
        ...
        if (status == HAL_OK) {
            if (Divider == DIVIDER_P_UPDATE) {
                ...
                /* Configure the PLLSAI1 Division factor M, P and Multiplication
                 * factor N*/
...
#else
                /* Configure the PLLSAI1 Division factor P and Multiplication
                 * factor N*/
#if defined(RCC_PLLSAI1P_DIV_2_31_SUPPORT)
                MODIFY_REG(
                    RCC->PLLSAI1CFGR,
...
#if defined(RCC_PLLSAI1M_DIV_1_16_SUPPORT)
                /* Configure the PLLSAI1 Division factor M, Q and Multiplication
                 * factor N*/
                MODIFY_REG(RCC->PLLSAI1CFGR,
                           ...
                           (PllSai1->PLLSAI1N << RCC_PLLSAI1CFGR_PLLSAI1N_Pos) |
                               ...
                               ((PllSai1->PLLSAI1M - 1U)
                                << RCC_PLLSAI1CFGR_PLLSAI1M_Pos));
#else
                /* Configure the PLLSAI1 Division factor Q and Multiplication
                 * factor N*/
                MODIFY_REG(RCC->PLLSAI1CFGR,
                           RCC_PLLSAI1CFGR_PLLSAI1N | RCC_PLLSAI1CFGR_PLLSAI1Q,
                           (PllSai1->PLLSAI1N << RCC_PLLSAI1CFGR_PLLSAI1N_Pos) |
...
#if defined(RCC_PLLSAI1M_DIV_1_16_SUPPORT)
                /* Configure the PLLSAI1 Division factor M, R and Multiplication
                 * factor N*/
                MODIFY_REG(RCC->PLLSAI1CFGR,
                           ...
                           (PllSai1->PLLSAI1N << RCC_PLLSAI1CFGR_PLLSAI1N_Pos) |
                               ...
                               ((PllSai1->PLLSAI1M - 1U)
                                << RCC_PLLSAI1CFGR_PLLSAI1M_Pos));
#else
                /* Configure the PLLSAI1 Division factor R and Multiplication
                 * factor N*/
                MODIFY_REG(RCC->PLLSAI1CFGR,
                           RCC_PLLSAI1CFGR_PLLSAI1N | RCC_PLLSAI1CFGR_PLLSAI1R,
                           (PllSai1->PLLSAI1N << RCC_PLLSAI1CFGR_PLLSAI1N_Pos) |
                                              ...
                                              uint32_t                Divider)
{
    ...
    if (__HAL_RCC_GET_PLL_OSCSOURCE() != RCC_PLLSOURCE_NONE) {
        ...
        if (status == HAL_OK) {
            ...
            MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM,
                       PllSai2->PLLSAI2Source | (PllSai2->PLLSAI2M - 1U)
                                                    << RCC_PLLCFGR_PLLM_Pos);
#endif
        }
    }
    ...
    if (status == HAL_OK) {
        ...
        if (status == HAL_OK) {
            if (Divider == DIVIDER_P_UPDATE) {
                ...
                /* Configure the PLLSAI2 Division factor M, P and Multiplication
                 * factor N*/
...
#else
                /* Configure the PLLSAI2 Division factor P and Multiplication
                 * factor N*/
#if defined(RCC_PLLSAI2P_DIV_2_31_SUPPORT)
                MODIFY_REG(
                    RCC->PLLSAI2CFGR,
...
#if defined(RCC_PLLSAI2M_DIV_1_16_SUPPORT)
                /* Configure the PLLSAI2 Division factor M, Q and Multiplication
                 * factor N*/
                MODIFY_REG(RCC->PLLSAI2CFGR,
                           ...
                           (PllSai2->PLLSAI2N << RCC_PLLSAI2CFGR_PLLSAI2N_Pos) |
                               ...
                               ((PllSai2->PLLSAI2M - 1U)
                                << RCC_PLLSAI2CFGR_PLLSAI2M_Pos));
#else
                /* Configure the PLLSAI2 Division factor Q and Multiplication
                 * factor N*/
                MODIFY_REG(RCC->PLLSAI2CFGR,
                           RCC_PLLSAI2CFGR_PLLSAI2N | RCC_PLLSAI2CFGR_PLLSAI2Q,
                           (PllSai2->PLLSAI2N << RCC_PLLSAI2CFGR_PLLSAI2N_Pos) |
...
#if defined(RCC_PLLSAI2M_DIV_1_16_SUPPORT)
                /* Configure the PLLSAI2 Division factor M, R and Multiplication
                 * factor N*/
                MODIFY_REG(RCC->PLLSAI2CFGR,
                           ...
                           (PllSai2->PLLSAI2N << RCC_PLLSAI2CFGR_PLLSAI2N_Pos) |
                               ...
                               ((PllSai2->PLLSAI2M - 1U)
                                << RCC_PLLSAI2CFGR_PLLSAI2M_Pos));
#else
                /* Configure the PLLSAI2 Division factor R and Multiplication
                 * factor N*/
                MODIFY_REG(RCC->PLLSAI2CFGR,
                           RCC_PLLSAI2CFGR_PLLSAI2N | RCC_PLLSAI2CFGR_PLLSAI2R,
                           (PllSai2->PLLSAI2N << RCC_PLLSAI2CFGR_PLLSAI2N_Pos) |
                                           ...
                                           uint32_t InputFrequency)
{
    ...
    if (frequency == 0U) {
        ...
        {
            if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLSAI1RDY) &&
                (__HAL_RCC_GET_PLLSAI1CLKOUT_CONFIG(RCC_PLLSAI1_SAI1CLK) !=
                 0U)) {
#if defined(RCC_PLLSAI1M_DIV_1_16_SUPPORT)
                /* PLLSAI1M exists: apply PLLSAI1M divider for PLLSAI1 output
                 * computation */
    ...
    defined(STM32L4S7xx) || defined(STM32L4S9xx)
        ...
        if (srcclk == RCC_SAI1CLKSOURCE_PLL) {
            if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY) &&
                ...
                /* HSI automatically selected as clock source if PLLs not
                 * enabled */
                frequency = HSI_VALUE;
            } else {
                /* No clock source, frequency default init at 0 */
            ...
            if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLSAI2RDY) &&
                (__HAL_RCC_GET_PLLSAI2CLKOUT_CONFIG(RCC_PLLSAI2_SAI2CLK) !=
                 0U)) {
#if defined(RCC_PLLSAI2M_DIV_1_16_SUPPORT)
                /* PLLSAI2M exists: apply PLLSAI2M divider for PLLSAI2 output
                 * computation */
...
#if defined(RCC_PLLSAI2P_DIV_2_31_SUPPORT)
                pllp =
                    READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2PDIV) >>
                    RCC_PLLSAI2CFGR_PLLSAI2PDIV_Pos;
#endif
                if (pllp == 0U) {
                    if (READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2P) !=
                        0U) {
                        pllp = 17U;
                    } else {
                        pllp = 7U;
