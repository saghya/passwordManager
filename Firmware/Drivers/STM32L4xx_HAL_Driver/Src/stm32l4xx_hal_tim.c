 ...
 *         requires a timer reset to avoid unexpected direction
 *         due to DIR bit readonly in center aligned mode.
 *         Ex: call @ref HAL_TIM_OnePulse_DeInit() before
 ...
 *         Ex: A call for @ref HAL_TIM_Encoder_Init will erase the settings of
 * @ref HAL_TIM_ConfigClockSource using TIM_CLOCKSOURCE_ETRMODE2 and vice versa
                                                   ...
                                                   uint32_t        DataLength)
{
    ...
    switch (BurstRequestSrc) {
        case TIM_DMA_UPDATE: {
            ...
            /* Enable the DMA channel */
            if (HAL_DMA_Start_IT(
                    htim->hdma[TIM_DMA_ID_UPDATE], (uint32_t)BurstBuffer,
        ...
        case TIM_DMA_CC1: {
            ...
            /* Enable the DMA channel */
            if (HAL_DMA_Start_IT(
                    htim->hdma[TIM_DMA_ID_CC1], (uint32_t)BurstBuffer,
                    (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
                /* Return error status */
                return HAL_ERROR;
            }
        ...
        case TIM_DMA_CC2: {
            ...
            /* Enable the DMA channel */
            if (HAL_DMA_Start_IT(
                    htim->hdma[TIM_DMA_ID_CC2], (uint32_t)BurstBuffer,
                    (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
                /* Return error status */
                return HAL_ERROR;
            }
        ...
        case TIM_DMA_CC3: {
            ...
            /* Enable the DMA channel */
            if (HAL_DMA_Start_IT(
                    htim->hdma[TIM_DMA_ID_CC3], (uint32_t)BurstBuffer,
                    (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
                /* Return error status */
                return HAL_ERROR;
            }
        ...
        case TIM_DMA_CC4: {
            ...
            /* Enable the DMA channel */
            if (HAL_DMA_Start_IT(
                    htim->hdma[TIM_DMA_ID_CC4], (uint32_t)BurstBuffer,
                    (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
                /* Return error status */
                return HAL_ERROR;
            }
        ...
        case TIM_DMA_COM: {
            ...
            /* Set the DMA error callback */
            htim->hdma[TIM_DMA_ID_COMMUTATION]->XferErrorCallback =
                TIM_DMAError;
        ...
        case TIM_DMA_TRIGGER: {
            ...
            htim->hdma[TIM_DMA_ID_TRIGGER]->XferCpltCallback =
                TIM_DMATriggerCplt;
 ...
 *         contains the OCREF clear feature and parameters for the TIM
 * peripheral.
    ...
    switch (sClearInputConfig->ClearInputSource) {
        case TIM_CLEARINPUTSOURCE_NONE: {
            ...
            CLEAR_BIT(htim->Instance->SMCR,
                      (TIM_SMCR_OCCS | TIM_SMCR_ETF | TIM_SMCR_ETPS |
                       TIM_SMCR_ECE | TIM_SMCR_ETP));
            break;
        }
        ...
        case TIM_CLEARINPUTSOURCE_ETR: {
            /* Check the parameters */
            assert_param(IS_TIM_CLEARINPUT_POLARITY(
                sClearInputConfig->ClearInputPolarity));
            assert_param(IS_TIM_CLEARINPUT_PRESCALER(
                          ...
                          const TIM_ClockConfigTypeDef *sClockSourceConfig)
{
    ...
    switch (sClockSourceConfig->ClockSource) {
        ...
        case TIM_CLOCKSOURCE_ETRMODE1: {
            ...
            assert_param(
                IS_TIM_CLOCKPOLARITY(sClockSourceConfig->ClockPolarity));
    ...
    if (htim->State == HAL_TIM_STATE_READY) {
        switch (CallbackID) {
            ...
            case HAL_TIM_HALL_SENSOR_MSPDEINIT_CB_ID:
                ...
                htim->HallSensor_MspDeInitCallback =
            ...
            case HAL_TIM_PWM_PULSE_FINISHED_CB_ID:
                ...
                htim->PWM_PulseFinishedCallback =
                         ...
                         const TIM_SlaveConfigTypeDef *sSlaveConfig)
{
    ...
    switch (sSlaveConfig->InputTrigger) {
        case TIM_TS_ETRF: {
            ...
            assert_param(IS_TIM_CLOCKSOURCE_ETRMODE1_INSTANCE(htim->Instance));
            assert_param(
                IS_TIM_TRIGGERPRESCALER(sSlaveConfig->TriggerPrescaler));
