                                    ...
                                    uint64_t Data)
{
    ...
    if (status == HAL_OK) {
        ...
        /* Deactivate the data cache if they are activated to avoid data
         * misbehavior */
...
void HAL_FLASH_IRQHandler(void)
{
    ...
    /* If the operation is completed, disable the PG, PNB, MER1, MER2 and PER
     * Bit */
    CLEAR_BIT(FLASH->CR,
 ...
 * been erased) Program: Address which was selected for data program
 * @retval None
 */
