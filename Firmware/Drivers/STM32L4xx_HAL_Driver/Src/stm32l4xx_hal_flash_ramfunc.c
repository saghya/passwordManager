...
__RAM_FUNC HAL_StatusTypeDef HAL_FLASHEx_OB_DBankConfig(uint32_t DBankConfig)
{
    ...
    if (reg > FLASH->PCROP1ER) {
        ...
        if (reg > FLASH->PCROP2ER) {
            ...
            reg = FLASH->WRP1AR;
            if (((reg & FLASH_WRP1AR_WRP1A_STRT) >>
                 FLASH_WRP1AR_WRP1A_STRT_Pos) <=
                ((reg & FLASH_WRP1AR_WRP1A_END) >>
            ...
            reg = FLASH->WRP1BR;
            if (((reg & FLASH_WRP1BR_WRP1B_STRT) >>
                 FLASH_WRP1BR_WRP1B_STRT_Pos) <=
                ((reg & FLASH_WRP1BR_WRP1B_END) >>
            ...
            reg = FLASH->WRP2AR;
            if (((reg & FLASH_WRP2AR_WRP2A_STRT) >>
                 FLASH_WRP2AR_WRP2A_STRT_Pos) <=
                ((reg & FLASH_WRP2AR_WRP2A_END) >>
            ...
            reg = FLASH->WRP2BR;
            if (((reg & FLASH_WRP2BR_WRP2B_STRT) >>
                 FLASH_WRP2BR_WRP2B_STRT_Pos) <=
                ((reg & FLASH_WRP2BR_WRP2B_END) >>
