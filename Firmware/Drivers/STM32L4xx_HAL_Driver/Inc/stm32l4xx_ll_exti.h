...
typedef struct {
    ...
    uint32_t
        Line_0_31; /*!< Specifies the EXTI lines to be enabled or disabled for Lines in range 0 to 31
                        This parameter can be any combination of @ref EXTI_LL_EC_LINE */

    uint32_t
        Line_32_63; /*!< Specifies the EXTI lines to be enabled or disabled for Lines in range 32 to 63
                         This parameter can be any combination of @ref EXTI_LL_EC_LINE */
 ...
 *       this bit when it is at '0' sets the corresponding pending bit in
 * EXTI_PR1 resulting in an interrupt request generation. This bit is cleared by
 * clearing the corresponding bit in the EXTI_PR1 register (by writing a 1 into
 * the bit)
 ...
 *       this bit when it is at '0' sets the corresponding pending bit in
 * EXTI_PR2 resulting in an interrupt request generation. This bit is cleared by
 * clearing the corresponding bit in the EXTI_PR2 register (by writing a 1 into
 * the bit)
