...
typedef struct {
    uint32_t
        SyncSignalID; /*!< Specifies the synchronization signal gating the DMA request in periodic mode.
                          This parameter can be a value of @ref DMAEx_DMAMUX_SyncSignalID_selection */

    uint32_t
        SyncPolarity; /*!< Specifies the polarity of the signal on which the DMA request is synchronized.
                          This parameter can be a value of @ref DMAEx_DMAMUX_SyncPolarity_selection */

    FunctionalState
        SyncEnable; /*!< Specifies if the synchronization shall be enabled or disabled
                         This parameter can take the value ENABLE or DISABLE*/

    FunctionalState
        EventEnable; /*!< Specifies if an event shall be generated once the RequestNumber is reached.
                          This parameter can take the value ENABLE or DISABLE */
...
typedef struct {
    uint32_t
        SignalID; /*!< Specifies the ID of the signal used for DMAMUX request generator
                       This parameter can be a value of @ref DMAEx_DMAMUX_SignalGeneratorID_selection */

    uint32_t
        Polarity; /*!< Specifies the polarity of the signal on which the request is generated.
                    This parameter can be a value of @ref DMAEx_DMAMUX_RequestGeneneratorPolarity_selection */

    uint32_t
        RequestNumber; /*!< Specifies the number of DMA request that will be generated after a signal event
                            This parameter must be a number between Min_Data = 1 and Max_Data = 32 */
...
#define HAL_DMAMUX1_SYNC_LPTIM2_OUT                                            \
    21U /*!<  Synchronization Signal is LPTIM2 OUT */
#if defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) ||    \
    defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
#define HAL_DMAMUX1_SYNC_DSI_TE                                                \
    22U /*!<  Synchronization Signal is DSI Tearing Effect      */
#define HAL_DMAMUX1_SYNC_DSI_EOT                                               \
    23U /*!<  Synchronization Signal is DSI End of refresh      */
#endif  /* STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx ||         \
           STM32L4S7xx || STM32L4S9xx */
#define HAL_DMAMUX1_SYNC_DMA2D_EOT                                             \
    24U /*!<  Synchronization Signal is DMA2D End of Transfer   */
#define HAL_DMAMUX1_SYNC_LDTC_IT                                               \
    25U /*!<  Synchronization Signal is LDTC IT    */
...
#define HAL_DMAMUX_SYNC_RISING                                                 \
    DMAMUX_CxCR_SPOL_0 /*!< synchronize with rising edge events */
#define HAL_DMAMUX_SYNC_FALLING                                                \
    DMAMUX_CxCR_SPOL_1 /*!< synchronize with falling edge events */
...
#define HAL_DMAMUX1_REQ_GEN_LPTIM2_OUT                                         \
    21U /*!< Request generator Signal is LPTIM2 OUT  */
#if defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) ||    \
    defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
#define HAL_DMAMUX1_REQ_GEN_DSI_TE                                             \
    22U /*!< Request generator Signal is DSI Tearing Effect      */
#define HAL_DMAMUX1_REQ_GEN_DSI_EOT                                            \
    23U /*!< Request generator Signal is DSI End of refresh      */
#endif  /* STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx ||         \
           STM32L4S7xx || STM32L4S9xx */
#define HAL_DMAMUX1_REQ_GEN_DMA2D_EOT                                          \
    24U /*!< Request generator Signal is DMA2D End of Transfer   */
#define HAL_DMAMUX1_REQ_GEN_LTDC_IT                                            \
    25U /*!< Request generator Signal is LTDC IT     */
...
#define HAL_DMAMUX_REQ_GEN_NO_EVENT                                            \
    0U /*!< block request generator events        */
...
#define IS_DMAMUX_SYNC_SIGNAL_ID(SIGNAL_ID)                                    \
    ((SIGNAL_ID) <= HAL_DMAMUX1_SYNC_LDTC_IT)
...
#define IS_DMAMUX_REQUEST_GEN_SIGNAL_ID(SIGNAL_ID)                             \
    ((SIGNAL_ID) <= HAL_DMAMUX1_REQ_GEN_LTDC_IT)
