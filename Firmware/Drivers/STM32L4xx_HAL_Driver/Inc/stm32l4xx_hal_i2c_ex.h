...
#define I2C_FMP_NOT_SUPPORTED                                                  \
    0xAAAA0000U /*!< Fast Mode Plus not supported       */
...
#define I2C_FASTMODEPLUS_PB8                                                   \
    (uint32_t)(                                                                \
        0x00000010U |                                                          \
        I2C_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PB8 not supported   */
#define I2C_FASTMODEPLUS_PB9                                                   \
    (uint32_t)(                                                                \
        0x00000012U |                                                          \
        I2C_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PB9 not supported   */
...
#define I2C_FASTMODEPLUS_I2C4                                                  \
    (uint32_t)(                                                                \
        0x00000800U |                                                          \
        I2C_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus I2C4 not supported  */
