...
typedef struct {
    uint32_t
        PVMType; /*!< PVMType: Specifies which voltage is monitored and against which threshold.
...
#define PWR_PVM_1                                                              \
    PWR_CR2_PVME1 /*!< Peripheral Voltage Monitoring 1 enable: VDDUSB versus 1.2 V (applicable when USB feature is supported) */
#endif            /* PWR_CR2_PVME1 */
#if defined(PWR_CR2_PVME2)
#define PWR_PVM_2                                                              \
    PWR_CR2_PVME2 /*!< Peripheral Voltage Monitoring 2 enable: VDDIO2 versus 0.9 V (applicable when VDDIO2 is present on device) */
#endif            /* PWR_CR2_PVME2 */
#define PWR_PVM_3                                                              \
    PWR_CR2_PVME3 /*!< Peripheral Voltage Monitoring 3 enable: VDDA versus 1.62 V */
#define PWR_PVM_4                                                              \
...
#define PWR_PVM_MODE_IT_RISING                                                 \
    ((uint32_t)0x00010001) /*!< External Interrupt Mode with Rising edge trigger detection */
...
#define PWR_PVM_MODE_IT_RISING_FALLING                                         \
    ((uint32_t)0x00010003) /*!< External Interrupt Mode with Rising/Falling edge trigger detection */
...
#define PWR_PVM_MODE_EVENT_RISING_FALLING                                      \
    ((uint32_t)0x00020003) /*!< Event Mode with Rising/Falling edge trigger detection */
/**
 * @}
 */
...
#define PWR_EXTI_LINE_PVM1                                                     \
    ((uint32_t)0x00000008) /*!< External interrupt line 35 Connected to the PVM1 EXTI Line   */
#endif                     /* PWR_CR2_PVME1 */
#if defined(PWR_CR2_PVME2)
#define PWR_EXTI_LINE_PVM2                                                     \
    ((uint32_t)0x00000010) /*!< External interrupt line 36 Connected to the PVM2 EXTI Line   */
#endif                     /* PWR_CR2_PVME2 */
#define PWR_EXTI_LINE_PVM3                                                     \
    ((uint32_t)0x00000020) /*!< External interrupt line 37 Connected to the PVM3 EXTI Line   */
#define PWR_EXTI_LINE_PVM4                                                     \
    ((uint32_t)0x00000040) /*!< External interrupt line 38 Connected to the PVM4 EXTI Line   */
/**
 * @}
 */
...
#define PWR_EVENT_LINE_PVM1                                                    \
    ((uint32_t)0x00000008) /*!< Event line 35 Connected to the PVM1 EXTI Line */
#endif                     /* PWR_CR2_PVME1 */
#if defined(PWR_CR2_PVME2)
#define PWR_EVENT_LINE_PVM2                                                    \
    ((uint32_t)0x00000010) /*!< Event line 36 Connected to the PVM2 EXTI Line */
#endif                     /* PWR_CR2_PVME2 */
#define PWR_EVENT_LINE_PVM3                                                    \
    ((uint32_t)0x00000020) /*!< Event line 37 Connected to the PVM3 EXTI Line */
#define PWR_EVENT_LINE_PVM4                                                    \
    ((uint32_t)0x00000040) /*!< Event line 38 Connected to the PVM4 EXTI Line */
/**
 * @}
 */
...
#define PWR_NO_SRAM2_RETENTION                                                 \
    ((uint32_t)0x00000000) /*!< SRAM2 is powered off in Standby mode (SRAM2 content is lost) */
#if defined(PWR_CR3_RRS_1)
#define PWR_FULL_SRAM2_RETENTION                                               \
    PWR_CR3_RRS_0 /*!< Full SRAM2 is powered by the low-power regulator in Standby mode */
#define PWR_4KBYTES_SRAM2_RETENTION                                            \
    PWR_CR3_RRS_1 /*!< Only 4 Kbytes of SRAM2 is powered by the low-power regulator in Standby mode */
#else
#define PWR_FULL_SRAM2_RETENTION                                               \
    PWR_CR3_RRS /*!< Full SRAM2 is powered by the low-power regulator in Standby mode */
#endif          /* PWR_CR3_RRS_1 */
/**
 * @}
 */
 ...
 * range 1 mode, typical output voltage at 1.2 V, system frequency up to 80 MHz.
 ...
 *        whether or not VOSF flag is cleared when moving from range 2 to
...
#define IS_PWR_PVM_TYPE(TYPE)                                                  \
    (((TYPE) == PWR_PVM_2) || ((TYPE) == PWR_PVM_3) || ((TYPE) == PWR_PVM_4))
#endif
...
#define IS_PWR_PVM_TYPE(TYPE)                                                  \
    (((TYPE) == PWR_PVM_1) || ((TYPE) == PWR_PVM_3) || ((TYPE) == PWR_PVM_4))
