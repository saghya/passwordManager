...
#define EXTERNAL_SAI1_CLOCK_VALUE                                              \
    48000U /*!< Value of the SAI1_EXTCLK external oscillator in Hz */
#endif     /* EXTERNAL_SAI1_CLOCK_VALUE */

#if !defined(EXTERNAL_SAI2_CLOCK_VALUE)
#define EXTERNAL_SAI2_CLOCK_VALUE                                              \
    48000U /*!< Value of the SAI2_EXTCLK external oscillator in Hz */
...
#define LL_RCC_CICR_PLLSAI2RDYC                                                \
...
#endif                   /* RCC_PLLSAI1_SUPPORT */
#if defined(RCC_PLLSAI2_SUPPORT)
#define LL_RCC_CIFR_PLLSAI2RDYF                                                \
 ...
 * @{
 */
#define LL_RCC_SYS_CLKSOURCE_MSI                                               \
 ...
 * @{
 */
#define LL_RCC_SYS_CLKSOURCE_STATUS_MSI                                        \
 ...
 * @{
 */
#define LL_RCC_STOP_WAKEUPCLOCK_MSI                                            \
...
#define LL_RCC_MCO1SOURCE_HSI                                                  \
    (RCC_CFGR_MCOSEL_0 |                                                       \
     RCC_CFGR_MCOSEL_1) /*!< HSI16 selection as MCO1 source */
...
#define LL_RCC_LPTIM1_CLKSOURCE_PCLK1                                          \
    RCC_CCIPR_LPTIM1SEL /*!< PCLK1 clock used as LPTIM1 clock source */
#define LL_RCC_LPTIM1_CLKSOURCE_LSI                                            \
    (RCC_CCIPR_LPTIM1SEL |                                                     \
     (RCC_CCIPR_LPTIM1SEL_0 >>                                                 \
      16U)) /*!< LSI clock used as LPTIM1 clock source */
#define LL_RCC_LPTIM1_CLKSOURCE_HSI                                            \
    (RCC_CCIPR_LPTIM1SEL |                                                     \
     (RCC_CCIPR_LPTIM1SEL_1 >>                                                 \
      16U)) /*!< HSI clock used as LPTIM1 clock source */
#define LL_RCC_LPTIM1_CLKSOURCE_LSE                                            \
    (RCC_CCIPR_LPTIM1SEL |                                                     \
     (RCC_CCIPR_LPTIM1SEL >>                                                   \
      16U)) /*!< LSE clock used as LPTIM1 clock source */
#define LL_RCC_LPTIM2_CLKSOURCE_PCLK1                                          \
    RCC_CCIPR_LPTIM2SEL /*!< PCLK1 clock used as LPTIM2 clock source */
#define LL_RCC_LPTIM2_CLKSOURCE_LSI                                            \
    (RCC_CCIPR_LPTIM2SEL |                                                     \
     (RCC_CCIPR_LPTIM2SEL_0 >>                                                 \
      16U)) /*!< LSI clock used as LPTIM2 clock source */
#define LL_RCC_LPTIM2_CLKSOURCE_HSI                                            \
    (RCC_CCIPR_LPTIM2SEL |                                                     \
     (RCC_CCIPR_LPTIM2SEL_1 >>                                                 \
      16U)) /*!< HSI clock used as LPTIM2 clock source */
#define LL_RCC_LPTIM2_CLKSOURCE_LSE                                            \
    (RCC_CCIPR_LPTIM2SEL |                                                     \
     (RCC_CCIPR_LPTIM2SEL >>                                                   \
      16U)) /*!< LSE clock used as LPTIM2 clock source */
/**
 * @}
 */
...
#define LL_RCC_SAI1_CLKSOURCE_PLLSAI1                                          \
    (RCC_CCIPR2_SAI1SEL                                                        \
     << 16U) /*!< PLLSAI1 (PLLSAI1CLK) clock used as SAI1 clock source */
#define LL_RCC_SAI1_CLKSOURCE_PLLSAI2                                          \
    ((RCC_CCIPR2_SAI1SEL << 16U) |                                             \
     RCC_CCIPR2_SAI1SEL_0) /*!< PLLSAI2 (PLLSAI2CLK) clock used as SAI1 clock source */
#define LL_RCC_SAI1_CLKSOURCE_PLL                                              \
    ((RCC_CCIPR2_SAI1SEL << 16U) |                                             \
     RCC_CCIPR2_SAI1SEL_1) /*!< PLL (PLLSAI3CLK) clock used as SAI1 clock source */
...
#define LL_RCC_SAI1_CLKSOURCE_HSI                                              \
    ((RCC_CCIPR2_SAI1SEL << 16U) |                                             \
     RCC_CCIPR2_SAI1SEL_2) /*!< HSI clock used as SAI1 clock source */
#elif defined(RCC_CCIPR_SAI1SEL)
#define LL_RCC_SAI1_CLKSOURCE_PLLSAI1                                          \
    RCC_CCIPR_SAI1SEL /*!< PLLSAI1 clock used as SAI1 clock source */
#if defined(RCC_PLLSAI2_SUPPORT)
#define LL_RCC_SAI1_CLKSOURCE_PLLSAI2                                          \
    (RCC_CCIPR_SAI1SEL |                                                       \
     (RCC_CCIPR_SAI1SEL_0 >>                                                   \
      16U)) /*!< PLLSAI2 clock used as SAI1 clock source */
#endif      /* RCC_PLLSAI2_SUPPORT */
#define LL_RCC_SAI1_CLKSOURCE_PLL                                              \
    (RCC_CCIPR_SAI1SEL |                                                       \
     (RCC_CCIPR_SAI1SEL_1 >> 16U)) /*!< PLL clock used as SAI1 clock source */
#define LL_RCC_SAI1_CLKSOURCE_PIN                                              \
    (RCC_CCIPR_SAI1SEL |                                                       \
     (RCC_CCIPR_SAI1SEL >>                                                     \
      16U)) /*!< External input clock used as SAI1 clock source */
#endif      /* RCC_CCIPR2_SAI1SEL */

#if defined(RCC_CCIPR2_SAI2SEL)
#define LL_RCC_SAI2_CLKSOURCE_PLLSAI1                                          \
    (RCC_CCIPR2_SAI2SEL                                                        \
     << 16U) /*!< PLLSAI1 (PLLSAI1CLK) clock used as SAI2 clock source */
#define LL_RCC_SAI2_CLKSOURCE_PLLSAI2                                          \
    ((RCC_CCIPR2_SAI2SEL << 16U) |                                             \
     RCC_CCIPR2_SAI2SEL_0) /*!< PLLSAI2 (PLLSAI2CLK) clock used as SAI2 clock source */
#define LL_RCC_SAI2_CLKSOURCE_PLL                                              \
    ((RCC_CCIPR2_SAI2SEL << 16U) |                                             \
     RCC_CCIPR2_SAI2SEL_1) /*!< PLL (PLLSAI3CLK) clock used as SAI2 clock source */
#define LL_RCC_SAI2_CLKSOURCE_PIN                                              \
    ((RCC_CCIPR2_SAI2SEL << 16U) |                                             \
     (RCC_CCIPR2_SAI2SEL_1 |                                                   \
      RCC_CCIPR2_SAI2SEL_0)) /*!< External input clock used as SAI2 clock source */
#define LL_RCC_SAI2_CLKSOURCE_HSI                                              \
    ((RCC_CCIPR2_SAI2SEL << 16U) |                                             \
     RCC_CCIPR2_SAI2SEL_2) /*!< HSI clock used as SAI2 clock source */
#elif defined(RCC_CCIPR_SAI2SEL)
#define LL_RCC_SAI2_CLKSOURCE_PLLSAI1                                          \
    RCC_CCIPR_SAI2SEL /*!< PLLSAI1 clock used as SAI2 clock source */
#if defined(RCC_PLLSAI2_SUPPORT)
#define LL_RCC_SAI2_CLKSOURCE_PLLSAI2                                          \
    (RCC_CCIPR_SAI2SEL |                                                       \
     (RCC_CCIPR_SAI2SEL_0 >>                                                   \
      16U)) /*!< PLLSAI2 clock used as SAI2 clock source */
#endif      /* RCC_PLLSAI2_SUPPORT */
#define LL_RCC_SAI2_CLKSOURCE_PLL                                              \
    (RCC_CCIPR_SAI2SEL |                                                       \
     (RCC_CCIPR_SAI2SEL_1 >> 16U)) /*!< PLL clock used as SAI2 clock source */
#define LL_RCC_SAI2_CLKSOURCE_PIN                                              \
    (RCC_CCIPR_SAI2SEL |                                                       \
     (RCC_CCIPR_SAI2SEL >>                                                     \
      16U)) /*!< External input clock used as SAI2 clock source */
 ...
 * @{
 */
#define LL_RCC_SDMMC1_KERNELCLKSOURCE_48CLK                                    \
    0x00000000U /*!< 48MHz clock from internal multiplexor used as SDMMC1 clock source */
#define LL_RCC_SDMMC1_KERNELCLKSOURCE_PLLP                                     \
    RCC_CCIPR2_SDMMCSEL /*!< PLLSAI3CLK clock used as SDMMC1 clock source */
/**
 * @}
 */
 ...
 */
#if defined(RCC_HSI48_SUPPORT)
#define LL_RCC_SDMMC1_CLKSOURCE_HSI48                                          \
    0x00000000U /*!< HSI48 clock used as SDMMC1 clock source */
#else
#define LL_RCC_SDMMC1_CLKSOURCE_NONE                                           \
    0x00000000U /*!< No clock used as SDMMC1 clock source */
#endif
#if defined(RCC_PLLSAI1_SUPPORT)
#define LL_RCC_SDMMC1_CLKSOURCE_PLLSAI1                                        \
    RCC_CCIPR_CLK48SEL_0 /*!< PLLSAI1 clock used as SDMMC1 clock source */
#endif                   /* RCC_PLLSAI1_SUPPORT */
#define LL_RCC_SDMMC1_CLKSOURCE_PLL                                            \
    RCC_CCIPR_CLK48SEL_1 /*!< PLL clock used as SDMMC1 clock source */
#define LL_RCC_SDMMC1_CLKSOURCE_MSI                                            \
    RCC_CCIPR_CLK48SEL /*!< MSI clock used as SDMMC1 clock source */
/**
 * @}
 */
#endif /* SDMMC1 */
...
#define LL_RCC_RNG_CLKSOURCE_NONE                                              \
    0x00000000U /*!< No clock used as RNG clock source */
#endif
#if defined(RCC_PLLSAI1_SUPPORT)
#define LL_RCC_RNG_CLKSOURCE_PLLSAI1                                           \
    RCC_CCIPR_CLK48SEL_0 /*!< PLLSAI1 clock used as RNG clock source */
#endif                   /* RCC_PLLSAI1_SUPPORT */
#define LL_RCC_RNG_CLKSOURCE_PLL                                               \
    RCC_CCIPR_CLK48SEL_1 /*!< PLL clock used as RNG clock source */
#define LL_RCC_RNG_CLKSOURCE_MSI                                               \
    RCC_CCIPR_CLK48SEL /*!< MSI clock used as RNG clock source */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_ADC_CLKSOURCE_NONE                                              \
    0x00000000U /*!< No clock used as ADC clock source */
#if defined(RCC_PLLSAI1_SUPPORT)
#define LL_RCC_ADC_CLKSOURCE_PLLSAI1                                           \
    RCC_CCIPR_ADCSEL_0 /*!< PLLSAI1 clock used as ADC clock source */
#endif                 /* RCC_PLLSAI1_SUPPORT */
#if defined(RCC_PLLSAI2_SUPPORT) && !defined(LTDC)
#define LL_RCC_ADC_CLKSOURCE_PLLSAI2                                           \
    RCC_CCIPR_ADCSEL_1 /*!< PLLSAI2 clock used as ADC clock source */
#endif                 /* RCC_PLLSAI2_SUPPORT */
#if defined(RCC_CCIPR_ADCSEL)
#define LL_RCC_ADC_CLKSOURCE_SYSCLK                                            \
    RCC_CCIPR_ADCSEL /*!< SYSCLK clock used as ADC clock source */
#else
#define LL_RCC_ADC_CLKSOURCE_SYSCLK                                            \
    0x30000000U /*!< SYSCLK clock used as ADC clock source */
#endif
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_SWPMI1_CLKSOURCE_PCLK1                                          \
    0x00000000U /*!< PCLK1 used as SWPMI1 clock source */
#define LL_RCC_SWPMI1_CLKSOURCE_HSI                                            \
    RCC_CCIPR_SWPMI1SEL /*!< HSI used as SWPMI1 clock source */
/**
 * @}
 */
#endif /* SWPMI1 */
 ...
 * @{
 */
#define LL_RCC_DFSDM1_AUDIO_CLKSOURCE_SAI1                                     \
    0x00000000U /*!< SAI1 clock used as DFSDM1 Audio clock */
#define LL_RCC_DFSDM1_AUDIO_CLKSOURCE_HSI                                      \
    RCC_CCIPR2_ADFSDM1SEL_0 /*!< HSI clock used as DFSDM1 Audio clock */
#define LL_RCC_DFSDM1_AUDIO_CLKSOURCE_MSI                                      \
    RCC_CCIPR2_ADFSDM1SEL_1 /*!< MSI clock used as DFSDM1 Audio clock */
/**
 * @}
 */
...
#define LL_RCC_DFSDM1_CLKSOURCE_PCLK2                                          \
    0x00000000U /*!< PCLK2 used as DFSDM1 clock source */
#define LL_RCC_DFSDM1_CLKSOURCE_SYSCLK                                         \
    RCC_CCIPR2_DFSDM1SEL /*!< SYSCLK used as DFSDM1 clock source */
#else
#define LL_RCC_DFSDM1_CLKSOURCE_PCLK2                                          \
    0x00000000U /*!< PCLK2 used as DFSDM1 clock source */
#define LL_RCC_DFSDM1_CLKSOURCE_SYSCLK                                         \
    RCC_CCIPR_DFSDM1SEL /*!< SYSCLK used as DFSDM1 clock source */
 ...
 * @{
 */
#define LL_RCC_DSI_CLKSOURCE_PHY                                               \
    0x00000000U /*!< DSI-PHY clock used as DSI byte lane clock source */
#define LL_RCC_DSI_CLKSOURCE_PLL                                               \
    RCC_CCIPR2_DSISEL /*!< PLL clock used as DSI byte lane clock source */
/**
 * @}
 */
#endif /* DSI */
 ...
 * @{
 */
#define LL_RCC_LTDC_CLKSOURCE_PLLSAI2R_DIV2                                    \
    0x00000000U /*!< PLLSAI2DIVR divided by 2 used as LTDC clock source */
#define LL_RCC_LTDC_CLKSOURCE_PLLSAI2R_DIV4                                    \
    RCC_CCIPR2_PLLSAI2DIVR_0 /*!< PLLSAI2DIVR divided by 4 used as LTDC clock source */
#define LL_RCC_LTDC_CLKSOURCE_PLLSAI2R_DIV8                                    \
    RCC_CCIPR2_PLLSAI2DIVR_1 /*!< PLLSAI2DIVR divided by 8 used as LTDC clock source */
#define LL_RCC_LTDC_CLKSOURCE_PLLSAI2R_DIV16                                   \
    RCC_CCIPR2_PLLSAI2DIVR /*!< PLLSAI2DIVR divided by 16 used as LTDC clock source */
/**
 * @}
 */
#endif /* LTDC */
 ...
 * @{
 */
#define LL_RCC_OCTOSPI_CLKSOURCE_SYSCLK                                        \
    0x00000000U /*!< SYSCLK used as OctoSPI clock source */
#define LL_RCC_OCTOSPI_CLKSOURCE_MSI                                           \
    RCC_CCIPR2_OSPISEL_0 /*!< MSI used as OctoSPI clock source */
#define LL_RCC_OCTOSPI_CLKSOURCE_PLL                                           \
    RCC_CCIPR2_OSPISEL_1 /*!< PLL used as OctoSPI clock source */
/**
 * @}
 */
#endif /* OCTOSPI1 */
...
#define LL_RCC_LPTIM2_CLKSOURCE                                                \
    RCC_CCIPR_LPTIM2SEL /*!< LPTIM2 Clock source selection */
/**
 * @}
 */
...
#define LL_RCC_SAI1_CLKSOURCE                                                  \
    RCC_CCIPR2_SAI1SEL /*!< SAI1 Clock source selection */
#else
#define LL_RCC_SAI1_CLKSOURCE                                                  \
...
#define LL_RCC_SAI2_CLKSOURCE                                                  \
    RCC_CCIPR2_SAI2SEL /*!< SAI2 Clock source selection */
#elif defined(RCC_CCIPR_SAI2SEL)
#define LL_RCC_SAI2_CLKSOURCE                                                  \
    RCC_CCIPR_SAI2SEL /*!< SAI2 Clock source selection */
#endif                /* RCC_CCIPR2_SAI2SEL */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_SDMMC1_KERNELCLKSOURCE                                          \
    RCC_CCIPR2_SDMMCSEL /*!< SDMMC1 Kernel Clock source selection */
/**
 * @}
 */
#endif /* RCC_CCIPR2_SDMMCSEL */
...
#define LL_RCC_SDMMC1_CLKSOURCE                                                \
    RCC_CCIPR_CLK48SEL /*!< SDMMC1 Clock source selection */
/**
 * @}
 */
#endif /* SDMMC1 */
 ...
 * @{
 */
#define LL_RCC_SWPMI1_CLKSOURCE                                                \
 ...
 * @{
 */
#define LL_RCC_DFSDM1_AUDIO_CLKSOURCE                                          \
    RCC_CCIPR2_ADFSDM1SEL /* DFSDM1 Audio Clock source selection */
/**
 * @}
 */
 ...
 */
#if defined(RCC_CCIPR2_DFSDM1SEL)
#define LL_RCC_DFSDM1_CLKSOURCE                                                \
    RCC_CCIPR2_DFSDM1SEL /*!< DFSDM1 Clock source selection */
#else
#define LL_RCC_DFSDM1_CLKSOURCE                                                \
    RCC_CCIPR_DFSDM1SEL /*!< DFSDM1 Clock source selection */
#endif                  /* RCC_CCIPR2_DFSDM1SEL */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_DSI_CLKSOURCE                                                   \
    RCC_CCIPR2_DSISEL /*!< DSI Clock source selection */
/**
 * @}
 */
#endif /* DSI */
...
#define LL_RCC_LTDC_CLKSOURCE                                                  \
    RCC_CCIPR2_PLLSAI2DIVR /*!< LTDC Clock source selection */
/**
 * @}
 */
#endif /* LTDC */
...
#define LL_RCC_OCTOSPI_CLKSOURCE                                               \
    RCC_CCIPR2_OSPISEL /*!< OctoSPI Clock source selection */
/**
 * @}
 */
#endif /* OCTOSPI1 */
...
#define LL_RCC_PLLSOURCE_MSI                                                   \
    RCC_PLLCFGR_PLLSRC_MSI /*!< MSI clock selected as PLL entry clock source */
 ...
 * @{
 */
#define LL_RCC_PLLM_DIV_1                                                      \
    0x00000000U /*!< Main PLL division factor for PLLM input by 1 */
#define LL_RCC_PLLM_DIV_2                                                      \
    (RCC_PLLCFGR_PLLM_0) /*!< Main PLL division factor for PLLM input by 2 */
#define LL_RCC_PLLM_DIV_3                                                      \
    (RCC_PLLCFGR_PLLM_1) /*!< Main PLL division factor for PLLM input by 3 */
#define LL_RCC_PLLM_DIV_4                                                      \
    (RCC_PLLCFGR_PLLM_1 |                                                      \
     RCC_PLLCFGR_PLLM_0) /*!< Main PLL division factor for PLLM input by 4 */
#define LL_RCC_PLLM_DIV_5                                                      \
    (RCC_PLLCFGR_PLLM_2) /*!< Main PLL division factor for PLLM input by 5 */
#define LL_RCC_PLLM_DIV_6                                                      \
    (RCC_PLLCFGR_PLLM_2 |                                                      \
     RCC_PLLCFGR_PLLM_0) /*!< Main PLL division factor for PLLM input by 6 */
#define LL_RCC_PLLM_DIV_7                                                      \
    (RCC_PLLCFGR_PLLM_2 |                                                      \
     RCC_PLLCFGR_PLLM_1) /*!< Main PLL division factor for PLLM input by 7 */
#define LL_RCC_PLLM_DIV_8                                                      \
    (RCC_PLLCFGR_PLLM_2 | RCC_PLLCFGR_PLLM_1 |                                 \
     RCC_PLLCFGR_PLLM_0) /*!< Main PLL division factor for PLLM input by 8 */
#if defined(RCC_PLLM_DIV_1_16_SUPPORT)
#define LL_RCC_PLLM_DIV_9                                                      \
    (RCC_PLLCFGR_PLLM_3) /*!< Main PLL division factor for PLLM input by 9 */
#define LL_RCC_PLLM_DIV_10                                                     \
    (RCC_PLLCFGR_PLLM_3 |                                                      \
     RCC_PLLCFGR_PLLM_0) /*!< Main PLL division factor for PLLM input by 10 */
#define LL_RCC_PLLM_DIV_11                                                     \
    (RCC_PLLCFGR_PLLM_3 |                                                      \
     RCC_PLLCFGR_PLLM_1) /*!< Main PLL division factor for PLLM input by 11 */
#define LL_RCC_PLLM_DIV_12                                                     \
    (RCC_PLLCFGR_PLLM_3 | RCC_PLLCFGR_PLLM_1 |                                 \
     RCC_PLLCFGR_PLLM_0) /*!< Main PLL division factor for PLLM input by 12 */
#define LL_RCC_PLLM_DIV_13                                                     \
    (RCC_PLLCFGR_PLLM_3 |                                                      \
     RCC_PLLCFGR_PLLM_2) /*!< Main PLL division factor for PLLM input by 13 */
#define LL_RCC_PLLM_DIV_14                                                     \
    (RCC_PLLCFGR_PLLM_3 | RCC_PLLCFGR_PLLM_2 |                                 \
     RCC_PLLCFGR_PLLM_0) /*!< Main PLL division factor for PLLM input by 14 */
#define LL_RCC_PLLM_DIV_15                                                     \
    (RCC_PLLCFGR_PLLM_3 | RCC_PLLCFGR_PLLM_2 |                                 \
     RCC_PLLCFGR_PLLM_1) /*!< Main PLL division factor for PLLM input by 15 */
#define LL_RCC_PLLM_DIV_16                                                     \
    (RCC_PLLCFGR_PLLM_3 | RCC_PLLCFGR_PLLM_2 | RCC_PLLCFGR_PLLM_1 |            \
     RCC_PLLCFGR_PLLM_0) /*!< Main PLL division factor for PLLM input by 16 */
...
#define LL_RCC_PLLR_DIV_6                                                      \
    (RCC_PLLCFGR_PLLR_1) /*!< Main PLL division factor for PLLCLK (system clock) by 6 */
...
#else
#define LL_RCC_PLLP_DIV_7                                                      \
    0x00000000U /*!< Main PLL division factor for PLLP output by 7 */
#define LL_RCC_PLLP_DIV_17                                                     \
    (RCC_PLLCFGR_PLLP) /*!< Main PLL division factor for PLLP output by 17 */
 ...
 * @{
 */
#define LL_RCC_PLLSAI1M_DIV_1                                                  \
    0x00000000U /*!< PLLSAI1 division factor for PLLSAI1M input by 1 */
#define LL_RCC_PLLSAI1M_DIV_2                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1M_0) /*!< PLLSAI1 division factor for PLLSAI1M input by 2 */
#define LL_RCC_PLLSAI1M_DIV_3                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1M_1) /*!< PLLSAI1 division factor for PLLSAI1M input by 3 */
#define LL_RCC_PLLSAI1M_DIV_4                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1M_1 |                                              \
     RCC_PLLSAI1CFGR_PLLSAI1M_0) /*!< PLLSAI1 division factor for PLLSAI1M input by 4 */
#define LL_RCC_PLLSAI1M_DIV_5                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1M_2) /*!< PLLSAI1 division factor for PLLSAI1M input by 5 */
#define LL_RCC_PLLSAI1M_DIV_6                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1M_2 |                                              \
     RCC_PLLSAI1CFGR_PLLSAI1M_0) /*!< PLLSAI1 division factor for PLLSAI1M input by 6 */
#define LL_RCC_PLLSAI1M_DIV_7                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1M_2 |                                              \
     RCC_PLLSAI1CFGR_PLLSAI1M_1) /*!< PLLSAI1 division factor for PLLSAI1M input by 7 */
#define LL_RCC_PLLSAI1M_DIV_8                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1M_2 | RCC_PLLSAI1CFGR_PLLSAI1M_1 |                 \
     RCC_PLLSAI1CFGR_PLLSAI1M_0) /*!< PLLSAI1 division factor for PLLSAI1M input by 8 */
#define LL_RCC_PLLSAI1M_DIV_9                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1M_3) /*!< PLLSAI1 division factor for PLLSAI1M input by 9 */
#define LL_RCC_PLLSAI1M_DIV_10                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1M_3 |                                              \
     RCC_PLLSAI1CFGR_PLLSAI1M_0) /*!< PLLSAI1 division factor for PLLSAI1M input by 10 */
#define LL_RCC_PLLSAI1M_DIV_11                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1M_3 |                                              \
     RCC_PLLSAI1CFGR_PLLSAI1M_1) /*!< PLLSAI1 division factor for PLLSAI1M input by 11 */
#define LL_RCC_PLLSAI1M_DIV_12                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1M_3 | RCC_PLLSAI1CFGR_PLLSAI1M_1 |                 \
     RCC_PLLSAI1CFGR_PLLSAI1M_0) /*!< PLLSAI1 division factor for PLLSAI1M input by 12 */
#define LL_RCC_PLLSAI1M_DIV_13                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1M_3 |                                              \
     RCC_PLLSAI1CFGR_PLLSAI1M_2) /*!< PLLSAI1 division factor for PLLSAI1M input by 13 */
#define LL_RCC_PLLSAI1M_DIV_14                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1M_3 | RCC_PLLSAI1CFGR_PLLSAI1M_2 |                 \
     RCC_PLLSAI1CFGR_PLLSAI1M_0) /*!< PLLSAI1 division factor for PLLSAI1M input by 14 */
#define LL_RCC_PLLSAI1M_DIV_15                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1M_3 | RCC_PLLSAI1CFGR_PLLSAI1M_2 |                 \
     RCC_PLLSAI1CFGR_PLLSAI1M_1) /*!< PLLSAI1 division factor for PLLSAI1M input by 15 */
#define LL_RCC_PLLSAI1M_DIV_16                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1M_3 | RCC_PLLSAI1CFGR_PLLSAI1M_2 |                 \
     RCC_PLLSAI1CFGR_PLLSAI1M_1 |                                              \
     RCC_PLLSAI1CFGR_PLLSAI1M_0) /*!< PLLSAI1 division factor for PLLSAI1M input by 16 */
/**
 * @}
 */
...
#define LL_RCC_PLLSAI1Q_DIV_2                                                  \
    0x00000000U /*!< PLLSAI1 division factor for PLLSAI1Q output by 2 */
#define LL_RCC_PLLSAI1Q_DIV_4                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1Q_0) /*!< PLLSAI1 division factor for PLLSAI1Q output by 4 */
#define LL_RCC_PLLSAI1Q_DIV_6                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1Q_1) /*!< PLLSAI1 division factor for PLLSAI1Q output by 6 */
#define LL_RCC_PLLSAI1Q_DIV_8                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1Q) /*!< PLLSAI1 division factor for PLLSAI1Q output by 8 */
/**
 * @}
 */
...
#define LL_RCC_PLLSAI1P_DIV_2                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_1) /*!< PLLSAI1 division factor for PLLSAI1P output by 2 */
#define LL_RCC_PLLSAI1P_DIV_3                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_1 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 3 */
#define LL_RCC_PLLSAI1P_DIV_4                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_2) /*!< PLLSAI1 division factor for PLLSAI1P output by 4 */
#define LL_RCC_PLLSAI1P_DIV_5                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 5 */
#define LL_RCC_PLLSAI1P_DIV_6                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1) /*!< PLLSAI1 division factor for PLLSAI1P output by 6 */
#define LL_RCC_PLLSAI1P_DIV_7                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_1 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 7 */
#define LL_RCC_PLLSAI1P_DIV_8                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_3) /*!< PLLSAI1 division factor for PLLSAI1P output by 8 */
#define LL_RCC_PLLSAI1P_DIV_9                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 9 */
#define LL_RCC_PLLSAI1P_DIV_10                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1) /*!< PLLSAI1 division factor for PLLSAI1P output by 10 */
#define LL_RCC_PLLSAI1P_DIV_11                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_1 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 1 */
#define LL_RCC_PLLSAI1P_DIV_12                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_2) /*!< PLLSAI1 division factor for PLLSAI1P output by 12 */
#define LL_RCC_PLLSAI1P_DIV_13                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 13 */
#define LL_RCC_PLLSAI1P_DIV_14                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1) /*!< PLLSAI1 division factor for PLLSAI1P output by 14 */
#define LL_RCC_PLLSAI1P_DIV_15                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 15 */
#define LL_RCC_PLLSAI1P_DIV_16                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4) /*!< PLLSAI1 division factor for PLLSAI1P output by 16 */
#define LL_RCC_PLLSAI1P_DIV_17                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 17 */
#define LL_RCC_PLLSAI1P_DIV_18                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1) /*!< PLLSAI1 division factor for PLLSAI1P output by 18 */
#define LL_RCC_PLLSAI1P_DIV_19                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_1 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 19 */
#define LL_RCC_PLLSAI1P_DIV_20                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_2) /*!< PLLSAI1 division factor for PLLSAI1P output by 20 */
#define LL_RCC_PLLSAI1P_DIV_21                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division fctor for PLLSAI1P output by 21 */
#define LL_RCC_PLLSAI1P_DIV_22                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1) /*!< PLLSAI1 division factor for PLLSAI1P output by 22 */
#define LL_RCC_PLLSAI1P_DIV_23                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 23 */
#define LL_RCC_PLLSAI1P_DIV_24                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_3) /*!< PLLSAI1 division factor for PLLSAI1P output by 24 */
#define LL_RCC_PLLSAI1P_DIV_25                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 25 */
#define LL_RCC_PLLSAI1P_DIV_26                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1) /*!< PLLSAI1 division factor for PLLSAI1P output by 26 */
#define LL_RCC_PLLSAI1P_DIV_27                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 27 */
#define LL_RCC_PLLSAI1P_DIV_28                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_2) /*!< PLLSAI1 division factor for PLLSAI1P output by 28 */
#define LL_RCC_PLLSAI1P_DIV_29                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 29 */
#define LL_RCC_PLLSAI1P_DIV_30                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 |                                           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_1) /*!< PLLSAI1 division factor for PLLSAI1P output by 30 */
#define LL_RCC_PLLSAI1P_DIV_31                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1PDIV_4 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_3 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_2 | RCC_PLLSAI1CFGR_PLLSAI1PDIV_1 |           \
     RCC_PLLSAI1CFGR_PLLSAI1PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 31 */
#else
#define LL_RCC_PLLSAI1P_DIV_7                                                  \
    0x00000000U /*!< PLLSAI1 division factor for PLLSAI1P output by 7 */
#define LL_RCC_PLLSAI1P_DIV_17                                                 \
    (RCC_PLLSAI1CFGR_PLLSAI1P) /*!< PLLSAI1 division factor for PLLSAI1P output by 17 */
...
#define LL_RCC_PLLSAI1R_DIV_2                                                  \
    0x00000000U /*!< PLLSAI1 division factor for PLLSAI1R output by 2 */
#define LL_RCC_PLLSAI1R_DIV_4                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1R_0) /*!< PLLSAI1 division factor for PLLSAI1R output by 4 */
#define LL_RCC_PLLSAI1R_DIV_6                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1R_1) /*!< PLLSAI1 division factor for PLLSAI1R output by 6 */
#define LL_RCC_PLLSAI1R_DIV_8                                                  \
    (RCC_PLLSAI1CFGR_PLLSAI1R) /*!< PLLSAI1 division factor for PLLSAI1R output by 8 */
/**
 * @}
 */
#endif /* RCC_PLLSAI1_SUPPORT */
 ...
 * @{
 */
#define LL_RCC_PLLSAI2M_DIV_1                                                  \
    0x00000000U /*!< PLLSAI2 division factor for PLLSAI2M input by 1 */
#define LL_RCC_PLLSAI2M_DIV_2                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2M_0) /*!< PLLSAI2 division factor for PLLSAI2M input by 2 */
#define LL_RCC_PLLSAI2M_DIV_3                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2M_1) /*!< PLLSAI2 division factor for PLLSAI2M input by 3 */
#define LL_RCC_PLLSAI2M_DIV_4                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2M_1 |                                              \
     RCC_PLLSAI2CFGR_PLLSAI2M_0) /*!< PLLSAI2 division factor for PLLSAI2M input by 4 */
#define LL_RCC_PLLSAI2M_DIV_5                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2M_2) /*!< PLLSAI2 division factor for PLLSAI2M input by 5 */
#define LL_RCC_PLLSAI2M_DIV_6                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2M_2 |                                              \
     RCC_PLLSAI2CFGR_PLLSAI2M_0) /*!< PLLSAI2 division factor for PLLSAI2M input by 6 */
#define LL_RCC_PLLSAI2M_DIV_7                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2M_2 |                                              \
     RCC_PLLSAI2CFGR_PLLSAI2M_1) /*!< PLLSAI2 division factor for PLLSAI2M input by 7 */
#define LL_RCC_PLLSAI2M_DIV_8                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2M_2 | RCC_PLLSAI2CFGR_PLLSAI2M_1 |                 \
     RCC_PLLSAI2CFGR_PLLSAI2M_0) /*!< PLLSAI2 division factor for PLLSAI2M input by 8 */
#define LL_RCC_PLLSAI2M_DIV_9                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2M_3) /*!< PLLSAI2 division factor for PLLSAI2M input by 9 */
#define LL_RCC_PLLSAI2M_DIV_10                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2M_3 |                                              \
     RCC_PLLSAI2CFGR_PLLSAI2M_0) /*!< PLLSAI2 division factor for PLLSAI2M input by 10 */
#define LL_RCC_PLLSAI2M_DIV_11                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2M_3 |                                              \
     RCC_PLLSAI2CFGR_PLLSAI2M_1) /*!< PLLSAI2 division factor for PLLSAI2M input by 11 */
#define LL_RCC_PLLSAI2M_DIV_12                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2M_3 | RCC_PLLSAI2CFGR_PLLSAI2M_1 |                 \
     RCC_PLLSAI2CFGR_PLLSAI2M_0) /*!< PLLSAI2 division factor for PLLSAI2M input by 12 */
#define LL_RCC_PLLSAI2M_DIV_13                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2M_3 |                                              \
     RCC_PLLSAI2CFGR_PLLSAI2M_2) /*!< PLLSAI2 division factor for PLLSAI2M input by 13 */
#define LL_RCC_PLLSAI2M_DIV_14                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2M_3 | RCC_PLLSAI2CFGR_PLLSAI2M_2 |                 \
     RCC_PLLSAI2CFGR_PLLSAI2M_0) /*!< PLLSAI2 division factor for PLLSAI2M input by 14 */
#define LL_RCC_PLLSAI2M_DIV_15                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2M_3 | RCC_PLLSAI2CFGR_PLLSAI2M_2 |                 \
     RCC_PLLSAI2CFGR_PLLSAI2M_1) /*!< PLLSAI2 division factor for PLLSAI2M input by 15 */
#define LL_RCC_PLLSAI2M_DIV_16                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2M_3 | RCC_PLLSAI2CFGR_PLLSAI2M_2 |                 \
     RCC_PLLSAI2CFGR_PLLSAI2M_1 |                                              \
     RCC_PLLSAI2CFGR_PLLSAI2M_0) /*!< PLLSAI2 division factor for PLLSAI2M input by 16 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_PLLSAI2Q_DIV_2                                                  \
    0x00000000U /*!< PLLSAI2 division factor for PLLSAI2Q output by 2 */
#define LL_RCC_PLLSAI2Q_DIV_4                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2Q_0) /*!< PLLSAI2 division factor for PLLSAI2Q output by 4 */
#define LL_RCC_PLLSAI2Q_DIV_6                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2Q_1) /*!< PLLSAI2 division factor for PLLSAI2Q output by 6 */
#define LL_RCC_PLLSAI2Q_DIV_8                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2Q) /*!< PLLSAI2 division factor for PLLSAI2Q output by 8 */
/**
 * @}
 */
...
#define LL_RCC_PLLSAI2P_DIV_2                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_1) /*!< PLLSAI2 division factor for PLLSAI2P output by 2 */
#define LL_RCC_PLLSAI2P_DIV_3                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_1 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 3 */
#define LL_RCC_PLLSAI2P_DIV_4                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_2) /*!< PLLSAI2 division factor for PLLSAI2P output by 4 */
#define LL_RCC_PLLSAI2P_DIV_5                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 5 */
#define LL_RCC_PLLSAI2P_DIV_6                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1) /*!< PLLSAI2 division factor for PLLSAI2P output by 6 */
#define LL_RCC_PLLSAI2P_DIV_7                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_1 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 7 */
#define LL_RCC_PLLSAI2P_DIV_8                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_3) /*!< PLLSAI2 division factor for PLLSAI2P output by 8 */
#define LL_RCC_PLLSAI2P_DIV_9                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 9 */
#define LL_RCC_PLLSAI2P_DIV_10                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1) /*!< PLLSAI2 division factor for PLLSAI2P output by 10 */
#define LL_RCC_PLLSAI2P_DIV_11                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_1 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 1 */
#define LL_RCC_PLLSAI2P_DIV_12                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_2) /*!< PLLSAI2 division factor for PLLSAI2P output by 12 */
#define LL_RCC_PLLSAI2P_DIV_13                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 13 */
#define LL_RCC_PLLSAI2P_DIV_14                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1) /*!< PLLSAI2 division factor for PLLSAI2P output by 14 */
#define LL_RCC_PLLSAI2P_DIV_15                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 15 */
#define LL_RCC_PLLSAI2P_DIV_16                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4) /*!< PLLSAI2 division factor for PLLSAI2P output by 16 */
#define LL_RCC_PLLSAI2P_DIV_17                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 17 */
#define LL_RCC_PLLSAI2P_DIV_18                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1) /*!< PLLSAI2 division factor for PLLSAI2P output by 18 */
#define LL_RCC_PLLSAI2P_DIV_19                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_1 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 19 */
#define LL_RCC_PLLSAI2P_DIV_20                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_2) /*!< PLLSAI2 division factor for PLLSAI2P output by 20 */
#define LL_RCC_PLLSAI2P_DIV_21                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division fctor for PLLSAI2P output by 21 */
#define LL_RCC_PLLSAI2P_DIV_22                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1) /*!< PLLSAI2 division factor for PLLSAI2P output by 22 */
#define LL_RCC_PLLSAI2P_DIV_23                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 23 */
#define LL_RCC_PLLSAI2P_DIV_24                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_3) /*!< PLLSAI2 division factor for PLLSAI2P output by 24 */
#define LL_RCC_PLLSAI2P_DIV_25                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 25 */
#define LL_RCC_PLLSAI2P_DIV_26                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1) /*!< PLLSAI2 division factor for PLLSAI2P output by 26 */
#define LL_RCC_PLLSAI2P_DIV_27                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 27 */
#define LL_RCC_PLLSAI2P_DIV_28                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_2) /*!< PLLSAI2 division factor for PLLSAI2P output by 28 */
#define LL_RCC_PLLSAI2P_DIV_29                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI2 division factor for PLLSAI2P output by 29 */
#define LL_RCC_PLLSAI2P_DIV_30                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 |                                           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_1) /*!< PLLSAI2 division factor for PLLSAI2P output by 30 */
#define LL_RCC_PLLSAI2P_DIV_31                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2PDIV_4 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_3 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_2 | RCC_PLLSAI2CFGR_PLLSAI2PDIV_1 |           \
     RCC_PLLSAI2CFGR_PLLSAI2PDIV_0) /*!< PLLSAI1 division factor for PLLSAI1P output by 31 */
#else
#define LL_RCC_PLLSAI2P_DIV_7                                                  \
    0x00000000U /*!< PLLSAI2 division factor for PLLSAI2P output by 7 */
#define LL_RCC_PLLSAI2P_DIV_17                                                 \
    (RCC_PLLSAI2CFGR_PLLSAI2P) /*!< PLLSAI2 division factor for PLLSAI2P output by 17 */
 ...
 * @{
 */
#define LL_RCC_PLLSAI2R_DIV_2                                                  \
    0x00000000U /*!< PLLSAI2 division factor for PLLSAI2R output by 2 */
#define LL_RCC_PLLSAI2R_DIV_4                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2R_0) /*!< PLLSAI2 division factor for PLLSAI2R output by 4 */
#define LL_RCC_PLLSAI2R_DIV_6                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2R_1) /*!< PLLSAI2 division factor for PLLSAI2R output by 6 */
#define LL_RCC_PLLSAI2R_DIV_8                                                  \
    (RCC_PLLSAI2CFGR_PLLSAI2R) /*!< PLLSAI2 division factor for PLLSAI2R output by 8 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_PLLSAI2DIVR_DIV_2                                               \
    0x00000000U /*!< PLLSAI2 division factor for PLLSAI2DIVR output by 2 */
#define LL_RCC_PLLSAI2DIVR_DIV_4                                               \
    RCC_CCIPR2_PLLSAI2DIVR_0 /*!< PLLSAI2 division factor for PLLSAI2DIVR output by 4 */
#define LL_RCC_PLLSAI2DIVR_DIV_8                                               \
    RCC_CCIPR2_PLLSAI2DIVR_1 /*!< PLLSAI2 division factor for PLLSAI2DIVR output by 8 */
#define LL_RCC_PLLSAI2DIVR_DIV_16                                              \
    (RCC_CCIPR2_PLLSAI2DIVR_1 |                                                \
     RCC_CCIPR2_PLLSAI2DIVR_0) /*!< PLLSAI2 division factor for PLLSAI2DIVR output by 16 */
/**
 * @}
 */
...
#define LL_RCC_LSI_PREDIV_128                                                  \
    RCC_CSR_LSIPREDIV /*!< LSI division factor by 128 */
/**
 * @}
 */
...
#define __LL_RCC_CALC_PLLCLK_FREQ(__INPUTFREQ__, __PLLM__, __PLLN__, __PLLR__) \
    ((__INPUTFREQ__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) *         \
     (__PLLN__) / ((((__PLLR__) >> RCC_PLLCFGR_PLLR_Pos) + 1U) * 2U))
 ...
 * @retval PLL clock frequency (in Hz)
 */
#define __LL_RCC_CALC_PLLCLK_SAI_FREQ(__INPUTFREQ__, __PLLM__, __PLLN__,       \
                                      __PLLP__)                                \
    ((__INPUTFREQ__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) *         \
     (__PLLN__) / ((__PLLP__) >> RCC_PLLCFGR_PLLPDIV_Pos))
...
#define __LL_RCC_CALC_PLLCLK_SAI_FREQ(__INPUTFREQ__, __PLLM__, __PLLN__,       \
                                      __PLLP__)                                \
    ((__INPUTFREQ__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) *         \
     (__PLLN__) / (((__PLLP__) == LL_RCC_PLLP_DIV_7) ? 7U : 17U))
...
#define __LL_RCC_CALC_PLLCLK_48M_FREQ(__INPUTFREQ__, __PLLM__, __PLLN__,       \
                                      __PLLQ__)                                \
    ((__INPUTFREQ__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) *         \
     (__PLLN__) / ((((__PLLQ__) >> RCC_PLLCFGR_PLLQ_Pos) + 1U) << 1U))

#if defined(RCC_PLLSAI1_SUPPORT)
#if defined(RCC_PLLSAI1M_DIV_1_16_SUPPORT) &&                                  \
    defined(RCC_PLLSAI1P_DIV_2_31_SUPPORT)
/**
 ...
 */
#define __LL_RCC_CALC_PLLSAI1_SAI_FREQ(__INPUTFREQ__, __PLLSAI1M__,            \
                                       __PLLSAI1N__, __PLLSAI1P__)             \
    ((__INPUTFREQ__) /                                                         \
     ((((__PLLSAI1M__) >> RCC_PLLSAI1CFGR_PLLSAI1M_Pos) + 1U)) *               \
     (__PLLSAI1N__) / ((__PLLSAI1P__) >> RCC_PLLSAI1CFGR_PLLSAI1PDIV_Pos))
...
#define __LL_RCC_CALC_PLLSAI1_SAI_FREQ(__INPUTFREQ__, __PLLM__, __PLLSAI1N__,  \
                                       __PLLSAI1P__)                           \
    ((__INPUTFREQ__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) *         \
     (__PLLSAI1N__) / (((__PLLSAI1P__) == LL_RCC_PLLSAI1P_DIV_7) ? 7U : 17U))
 ...
 * @retval PLLSAI1 clock frequency (in Hz)
 */
#define __LL_RCC_CALC_PLLSAI1_48M_FREQ(__INPUTFREQ__, __PLLSAI1M__,            \
                                       __PLLSAI1N__, __PLLSAI1Q__)             \
    ((__INPUTFREQ__) /                                                         \
     ((((__PLLSAI1M__) >> RCC_PLLSAI1CFGR_PLLSAI1M_Pos) + 1U)) *               \
     (__PLLSAI1N__) /                                                          \
 ...
 * @retval PLLSAI1 clock frequency (in Hz)
 */
#define __LL_RCC_CALC_PLLSAI1_ADC_FREQ(__INPUTFREQ__, __PLLSAI1M__,            \
                                       __PLLSAI1N__, __PLLSAI1R__)             \
    ((__INPUTFREQ__) /                                                         \
     ((((__PLLSAI1M__) >> RCC_PLLSAI1CFGR_PLLSAI1M_Pos) + 1U)) *               \
     (__PLLSAI1N__) /                                                          \
...
#if defined(RCC_PLLSAI2M_DIV_1_16_SUPPORT) &&                                  \
    defined(RCC_PLLSAI2P_DIV_2_31_SUPPORT)
/**
 ...
 */
#define __LL_RCC_CALC_PLLSAI2_SAI_FREQ(__INPUTFREQ__, __PLLSAI2M__,            \
                                       __PLLSAI2N__, __PLLSAI2P__)             \
    ((__INPUTFREQ__) /                                                         \
     ((((__PLLSAI2M__) >> RCC_PLLSAI2CFGR_PLLSAI2M_Pos) + 1U)) *               \
     (__PLLSAI2N__) / ((__PLLSAI2P__) >> RCC_PLLSAI2CFGR_PLLSAI2PDIV_Pos))
 ...
 * @retval PLLSAI2 clock frequency (in Hz)
 */
#define __LL_RCC_CALC_PLLSAI2_SAI_FREQ(__INPUTFREQ__, __PLLM__, __PLLSAI2N__,  \
                                       __PLLSAI2P__)                           \
    ((__INPUTFREQ__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) *         \
     (__PLLSAI2N__) / ((__PLLSAI2P__) >> RCC_PLLSAI2CFGR_PLLSAI2PDIV_Pos))
...
#define __LL_RCC_CALC_PLLSAI2_SAI_FREQ(__INPUTFREQ__, __PLLM__, __PLLSAI2N__,  \
                                       __PLLSAI2P__)                           \
    ((__INPUTFREQ__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1)) *          \
     (__PLLSAI2N__) / (((__PLLSAI2P__) == LL_RCC_PLLSAI2P_DIV_7) ? 7U : 17U))
 ...
 *             @ref LL_RCC_PLLSAI2_GetN (), @ref LL_RCC_PLLSAI2_GetR (), @ref
 ...
 * @retval PLLSAI2 clock frequency (in Hz)
 */
#define __LL_RCC_CALC_PLLSAI2_LTDC_FREQ(                                       \
    __INPUTFREQ__, __PLLSAI2M__, __PLLSAI2N__, __PLLSAI2R__, __PLLSAI2DIVR__)  \
    (((__INPUTFREQ__) /                                                        \
      (((__PLLSAI2M__) >> RCC_PLLSAI2CFGR_PLLSAI2M_Pos) + 1U)) *               \
     (__PLLSAI2N__) /                                                          \
     (((((__PLLSAI2R__) >> RCC_PLLSAI2CFGR_PLLSAI2R_Pos) + 1U) << 1U) *        \
      (2UL << ((__PLLSAI2DIVR__) >> RCC_CCIPR2_PLLSAI2DIVR_Pos))))
 ...
 * @retval PLLSAI2 clock frequency (in Hz)
 */
#define __LL_RCC_CALC_PLLSAI2_ADC_FREQ(__INPUTFREQ__, __PLLM__, __PLLSAI2N__,  \
                                       __PLLSAI2R__)                           \
    ((__INPUTFREQ__) / ((((__PLLM__) >> RCC_PLLCFGR_PLLM_Pos) + 1U)) *         \
     (__PLLSAI2N__) /                                                          \
     ((((__PLLSAI2R__) >> RCC_PLLSAI2CFGR_PLLSAI2R_Pos) + 1U) << 1U))
 ...
 * @retval PLL clock frequency (in Hz)
 */
#define __LL_RCC_CALC_PLLSAI2_DSI_FREQ(__INPUTFREQ__, __PLLSAI2M__,            \
                                       __PLLSAI2N__, __PLLSAI2Q__)             \
    ((__INPUTFREQ__) /                                                         \
     ((((__PLLSAI2M__) >> RCC_PLLSAI2CFGR_PLLSAI2M_Pos) + 1U)) *               \
     (__PLLSAI2N__) /                                                          \
...
{
    return ((READ_BIT(RCC->CR, RCC_CR_HSIKERON) == RCC_CR_HSIKERON) ? 1UL
                                                                    : 0UL);
}
 ...
 *       which, when added to the HSICAL value, should trim the HSI to 16 MHz
 * +/- 1 %
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_MSI_Enable(void) { SET_BIT(RCC->CR, RCC_CR_MSION); }
...
{
    return ((READ_BIT(RCC->CR, RCC_CR_MSIRGSEL) == RCC_CR_MSIRGSEL) ? 1UL
                                                                    : 0UL);
}
...
{
    return (uint32_t)(READ_BIT(RCC->ICSCR, RCC_ICSCR_MSICAL) >>
...
{
    return (uint32_t)(READ_BIT(RCC->ICSCR, RCC_ICSCR_MSITRIM) >>
...
#else
    (void)ADCx; /* unused */
    return ((READ_BIT(RCC->AHB2ENR, RCC_AHB2ENR_ADCEN) != 0U)
 ...
 *       the Backup domain is reset, or unless a failure is detected on LSE
 ...
 */
#endif /* RCC_PLLP_DIV_2_31_SUPPORT */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_SAI(uint32_t Source, uint32_t PLLM,
...
{
    return ((READ_BIT(RCC->CR, RCC_CR_PLLSAI1RDY) == RCC_CR_PLLSAI1RDY) ? 1UL
                                                                        : 0UL);
}
                                                     ...
                                                     uint32_t PLLQ)
{
    ...
    MODIFY_REG(RCC->PLLSAI1CFGR,
               RCC_PLLSAI1CFGR_PLLSAI1M | RCC_PLLSAI1CFGR_PLLSAI1N |
                                                     ...
                                                     uint32_t PLLQ)
{
    ...
    MODIFY_REG(RCC->PLLSAI1CFGR,
               ...
               PLLN << RCC_PLLSAI1CFGR_PLLSAI1N_Pos | PLLQ);
}
#endif /* RCC_PLLSAI1M_DIV_1_16_SUPPORT */
                                                     ...
                                                     uint32_t PLLR)
{
    ...
    MODIFY_REG(RCC->PLLSAI1CFGR,
               ...
               PLLN << RCC_PLLSAI1CFGR_PLLSAI1N_Pos | PLLR);
}
#endif /* RCC_PLLSAI1M_DIV_1_16_SUPPORT */
...
{
    return (uint32_t)(READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1N) >>
...
{
    return ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1PEN) ==
...
{
    return ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1QEN) ==
...
{
    return ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1REN) ==
...
{
    return ((READ_BIT(RCC->CR, RCC_CR_PLLSAI2RDY) == RCC_CR_PLLSAI2RDY) ? 1UL
                                                                        : 0UL);
}
                                                     ...
                                                     uint32_t PLLP)
{
    ...
    MODIFY_REG(RCC->PLLSAI2CFGR,
               RCC_PLLSAI2CFGR_PLLSAI2M | RCC_PLLSAI2CFGR_PLLSAI2N |
                                                     ...
                                                     uint32_t PLLP)
{
    ...
    MODIFY_REG(RCC->PLLSAI2CFGR,
               ...
               PLLN << RCC_PLLSAI2CFGR_PLLSAI2N_Pos | PLLP);
}
#else
/**
 * @brief  Configure PLLSAI2 used for SAI domain clock
...
LL_RCC_PLLSAI2_ConfigDomain_LTDC(uint32_t Source, uint32_t PLLM, uint32_t PLLN,
                                 uint32_t PLLR, uint32_t PLLDIVR)
{
    MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC, Source);
    MODIFY_REG(RCC->PLLSAI2CFGR,
               RCC_PLLSAI2CFGR_PLLSAI2M | RCC_PLLSAI2CFGR_PLLSAI2N |
                                                     ...
                                                     uint32_t PLLR)
{
    ...
    MODIFY_REG(RCC->PLLSAI2CFGR,
               ...
               PLLN << RCC_PLLSAI2CFGR_PLLSAI2N_Pos | PLLR);
}
#endif /* LTDC */
...
{
    return (uint32_t)(READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2N) >>
...
{
    return ((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2PEN) ==
             (RCC_PLLSAI2CFGR_PLLSAI2PEN))
                ? 1UL
                : 0UL);
}
...
{
    return ((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2QEN) ==
...
{
    return ((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2REN) ==
...
{
    MODIFY_REG(RCC->DLYCFGR, RCC_DLYCFGR_OCTOSPI2_DLY,
               (Delay << RCC_DLYCFGR_OCTOSPI2_DLY_Pos));
}
#endif /* OCTOSPI2 */
...
{
    return ((READ_BIT(RCC->CIFR, RCC_CIFR_MSIRDYF) == RCC_CIFR_MSIRDYF) ? 1UL
                                                                        : 0UL);
}
...
{
    return (
        (READ_BIT(RCC->CIER, RCC_CIER_PLLSAI1RDYIE) == RCC_CIER_PLLSAI1RDYIE)
            ? 1UL
            : 0UL);
}
#endif /* RCC_PLLSAI1_SUPPORT */
...
{
    return (
        (READ_BIT(RCC->CIER, RCC_CIER_PLLSAI2RDYIE) == RCC_CIER_PLLSAI2RDYIE)
            ? 1UL
            : 0UL);
}
#endif /* RCC_PLLSAI2_SUPPORT */
