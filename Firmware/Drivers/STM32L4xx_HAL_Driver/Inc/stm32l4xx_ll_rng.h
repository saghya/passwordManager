...
typedef struct {
    uint32_t
        ClockErrorDetection; /*!< Clock error detection.
...
#define LL_RNG_CLKDIV_BY_8192                                                  \
    (RNG_CR_CLKDIV_3 | RNG_CR_CLKDIV_2 | RNG_CR_CLKDIV_0)
...
#define LL_RNG_NOTNIST_COMPLIANT                                               \
    (RNG_CR_NISTC) /*!< Non NIST compliant configuration */
