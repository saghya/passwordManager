...
typedef struct {
    ...
    uint32_t
        PLLSAI1Source; /*!< PLLSAI1Source: PLLSAI1 entry clock source.
                            This parameter must be a value of @ref RCC_PLL_Clock_Source */

#if defined(RCC_PLLSAI1M_DIV_1_16_SUPPORT)
    uint32_t
        PLLSAI1M; /*!< PLLSAI1M: specifies the division factor for PLLSAI1 input clock.
    ...
    uint32_t
        PLLSAI1N; /*!< PLLSAI1N: specifies the multiplication factor for PLLSAI1 VCO output clock.
                       This parameter must be a number between 8 and 86 or 127 depending on devices. */

    uint32_t
        PLLSAI1P; /*!< PLLSAI1P: specifies the division factor for SAI clock.
                       This parameter must be a value of @ref RCC_PLLP_Clock_Divider */

    uint32_t
        PLLSAI1Q; /*!< PLLSAI1Q: specifies the division factor for USB/RNG/SDMMC1 clock.
                       This parameter must be a value of @ref RCC_PLLQ_Clock_Divider */

    uint32_t
        PLLSAI1R; /*!< PLLSAI1R: specifies the division factor for ADC clock.
                       This parameter must be a value of @ref RCC_PLLR_Clock_Divider */

    uint32_t
        PLLSAI1ClockOut; /*!< PLLSAIClockOut: specifies PLLSAI1 output clock to be enabled.
...
typedef struct {
    ...
    uint32_t
        PLLSAI2Source; /*!< PLLSAI2Source: PLLSAI2 entry clock source.
                            This parameter must be a value of @ref RCC_PLL_Clock_Source */

#if defined(RCC_PLLSAI2M_DIV_1_16_SUPPORT)
    uint32_t
        PLLSAI2M; /*!< PLLSAI2M: specifies the division factor for PLLSAI2 input clock.
                       This parameter must be a number between Min_Data = 1 and Max_Data = 16 */
#else
    uint32_t
        PLLSAI2M; /*!< PLLSAI2M: specifies the division factor for PLLSAI2 input clock.
    ...
    uint32_t
        PLLSAI2N; /*!< PLLSAI2N: specifies the multiplication factor for PLLSAI2 VCO output clock.
                       This parameter must be a number between 8 and 86 or 127 depending on devices. */

    uint32_t
        PLLSAI2P; /*!< PLLSAI2P: specifies the division factor for SAI clock.
                       This parameter must be a value of @ref RCC_PLLP_Clock_Divider */

#if defined(RCC_PLLSAI2Q_DIV_SUPPORT)
    uint32_t
        PLLSAI2Q; /*!< PLLSAI2Q: specifies the division factor for DSI clock.
                       This parameter must be a value of @ref RCC_PLLQ_Clock_Divider */
#endif

    uint32_t
        PLLSAI2R; /*!< PLLSAI2R: specifies the division factor for ADC clock.
                       This parameter must be a value of @ref RCC_PLLR_Clock_Divider */

    uint32_t
        PLLSAI2ClockOut; /*!< PLLSAIClockOut: specifies PLLSAI2 output clock to be enabled.
...
typedef struct {
    ...
    RCC_PLLSAI1InitTypeDef
        PLLSAI1; /*!< PLLSAI1 structure parameters.
                      This parameter will be used only when PLLSAI1 is selected as Clock Source for SAI1, USB/RNG/SDMMC1 or ADC */
#endif           /* RCC_PLLSAI1_SUPPORT */
#if defined(RCC_PLLSAI2_SUPPORT)

    RCC_PLLSAI2InitTypeDef
        PLLSAI2; /*!< PLLSAI2 structure parameters.
                      This parameter will be used only when PLLSAI2 is selected as Clock Source for SAI2 or ADC */

#endif /* RCC_PLLSAI2_SUPPORT */

    uint32_t
        Usart1ClockSelection; /*!< Specifies USART1 clock source.
                                   This parameter can be a value of @ref RCCEx_USART1_Clock_Source */

    uint32_t
        Usart2ClockSelection; /*!< Specifies USART2 clock source.
                                   This parameter can be a value of @ref RCCEx_USART2_Clock_Source */

#if defined(USART3)

    uint32_t
        Usart3ClockSelection; /*!< Specifies USART3 clock source.
    ...
    uint32_t
        Uart4ClockSelection; /*!< Specifies UART4 clock source.
    ...
    uint32_t
        Uart5ClockSelection; /*!< Specifies UART5 clock source.
                                  This parameter can be a value of @ref RCCEx_UART5_Clock_Source */

#endif /* UART5 */

    uint32_t
        Lpuart1ClockSelection; /*!< Specifies LPUART1 clock source.
    ...
    uint32_t
        I2c2ClockSelection; /*!< Specifies I2C2 clock source.
    ...
    uint32_t
        I2c4ClockSelection; /*!< Specifies I2C4 clock source.
                                 This parameter can be a value of @ref RCCEx_I2C4_Clock_Source */

#endif /* I2C4 */

    uint32_t
        Lptim1ClockSelection; /*!< Specifies LPTIM1 clock source.
                                   This parameter can be a value of @ref RCCEx_LPTIM1_Clock_Source */

    uint32_t
        Lptim2ClockSelection; /*!< Specifies LPTIM2 clock source.
    ...
    uint32_t
        Sai2ClockSelection; /*!< Specifies SAI2 clock source.
    ...
    uint32_t
        UsbClockSelection; /*!< Specifies USB clock source (warning: same source for SDMMC1 and RNG).
    ...
    uint32_t
        Sdmmc1ClockSelection; /*!< Specifies SDMMC1 clock source (warning: same source for USB and RNG).
                                   This parameter can be a value of @ref RCCEx_SDMMC1_Clock_Source */

#endif /* SDMMC1 */

    uint32_t
        RngClockSelection; /*!< Specifies RNG clock source (warning: same source for USB and SDMMC1).
                                This parameter can be a value of @ref RCCEx_RNG_Clock_Source */

#if !defined(STM32L412xx) && !defined(STM32L422xx)
    uint32_t
        AdcClockSelection; /*!< Specifies ADC interface clock source.
    ...
    uint32_t
        Swpmi1ClockSelection; /*!< Specifies SWPMI1 clock source.
    ...
    uint32_t
        Dfsdm1ClockSelection; /*!< Specifies DFSDM1 clock source.
    ...
    uint32_t
        Dfsdm1AudioClockSelection; /*!< Specifies DFSDM1 audio clock source.
    ...
    uint32_t
        LtdcClockSelection; /*!< Specifies LTDC clock source.
    ...
    uint32_t
        DsiClockSelection; /*!< Specifies DSI clock source.
    ...
    uint32_t
        OspiClockSelection; /*!< Specifies OctoSPI clock source.
                                 This parameter can be a value of @ref RCCEx_OSPI_Clock_Source */

#endif

    uint32_t
        RTCClockSelection; /*!< Specifies RTC clock source.
...
typedef struct {
    uint32_t
        Prescaler; /*!< Specifies the division factor of the SYNC signal.
    ...
    uint32_t
        Polarity; /*!< Specifies the input polarity for the SYNC signal source.
                     This parameter can be a value of @ref RCCEx_CRS_SynchroPolarity */

    uint32_t
        ReloadValue; /*!< Specifies the value to be loaded in the frequency error counter with each SYNC event.
                         It can be calculated in using macro __HAL_RCC_CRS_RELOADVALUE_CALCULATE(__FTARGET__, __FSYNC__)
                        This parameter must be a number between 0 and 0xFFFF or a value of @ref RCCEx_CRS_ReloadValueDefault .*/

    uint32_t
        ErrorLimitValue; /*!< Specifies the value to be used to evaluate the captured frequency error value.
                            This parameter must be a number between 0 and 0xFF or a value of @ref RCCEx_CRS_ErrorLimitDefault */

    uint32_t
        HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the HSI48 oscillator.
...
typedef struct {
    ...
    uint32_t
        HSI48CalibrationValue; /*!< Specifies value loaded in HSI48 oscillator smooth trimming.
                                  This parameter must be a number between 0 and 0x7F for STM32L412xx/L422xx, between 0 and 0x3F otherwise */
    ...
    uint32_t
        FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the counting direction of the
...
#define RCC_SDMMC1CLKSOURCE_HSI48                                              \
    0x00000000U /*!< HSI48 clock selected as SDMMC1 clock          */
#else
#define RCC_SDMMC1CLKSOURCE_NONE                                               \
    0x00000000U /*!< No clock selected as SDMMC1 clock             */
#endif          /* RCC_HSI48_SUPPORT */
#define RCC_SDMMC1CLKSOURCE_PLLSAI1                                            \
    RCC_CCIPR_CLK48SEL_0 /*!< PLLSAI1 "Q" clock selected as SDMMC1 clock    */
#define RCC_SDMMC1CLKSOURCE_PLL                                                \
    RCC_CCIPR_CLK48SEL_1 /*!< PLL "Q" clock selected as SDMMC1 clock        */
#define RCC_SDMMC1CLKSOURCE_MSI                                                \
    RCC_CCIPR_CLK48SEL /*!< MSI clock selected as SDMMC1 clock            */
#if defined(RCC_CCIPR2_SDMMCSEL)
#define RCC_SDMMC1CLKSOURCE_PLLP                                               \
    RCC_CCIPR2_SDMMCSEL /*!< PLL "P" clock selected as SDMMC1 kernel clock */
...
#define RCC_EXTI_LINE_LSECSS                                                   \
    EXTI_IMR1_IM19 /*!< External interrupt line 19 connected to the LSE CSS EXTI Line */
/**
 * @}
 */
...
#define RCC_CRS_SYNC_DIV32                                                     \
    (CRS_CFGR_SYNCDIV_2 |                                                      \
     CRS_CFGR_SYNCDIV_0) /*!< Synchro Signal divided by 32 */
#define RCC_CRS_SYNC_DIV64                                                     \
    (CRS_CFGR_SYNCDIV_2 |                                                      \
     CRS_CFGR_SYNCDIV_1) /*!< Synchro Signal divided by 64 */
...
#define RCC_CRS_HSI48CALIBRATION_DEFAULT                                                                \
    0x00000040U /*!< The default value is 64, which corresponds to the middle of the trimming interval. \
...
#define __HAL_RCC_PLLSAI1_CONFIG(__PLLSAI1M__, __PLLSAI1N__, __PLLSAI1P__,     \
                                 __PLLSAI1Q__, __PLLSAI1R__)                   \
    MODIFY_REG(                                                                \
        RCC->PLLSAI1CFGR,                                                      \
        (RCC_PLLSAI1CFGR_PLLSAI1M | RCC_PLLSAI1CFGR_PLLSAI1N |                 \
         RCC_PLLSAI1CFGR_PLLSAI1P | RCC_PLLSAI1CFGR_PLLSAI1Q |                 \
...
#define __HAL_RCC_PLLSAI1_CONFIG(__PLLSAI1N__, __PLLSAI1P__, __PLLSAI1Q__,     \
                                 __PLLSAI1R__)                                 \
    MODIFY_REG(                                                                \
        RCC->PLLSAI1CFGR,                                                      \
 ...
 *
 * @param  __PLLSAI1N__ specifies the multiplication factor for PLLSAI1 VCO output clock.
 *          This parameter must be a number between 8 and 86 or 127 depending on
 * devices.
 * @note   You have to set the PLLSAI1N parameter correctly to ensure that the VCO
 *         output frequency is between 64 and 344 MHz.
 *         Use to set PLLSAI1 clock frequency = f(PLLSAI1) multiplied by
 * PLLSAI1N
 *
 * @retval None
 */
#define __HAL_RCC_PLLSAI1_MULN_CONFIG(__PLLSAI1N__)                            \
    MODIFY_REG(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1N,                     \
               (__PLLSAI1N__) << RCC_PLLSAI1CFGR_PLLSAI1N_Pos)
...
#define __HAL_RCC_PLLSAI1_DIVM_CONFIG(__PLLSAI1M__)                            \
    MODIFY_REG(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1M,                     \
               ((__PLLSAI1M__)-1U) << RCC_PLLSAI1CFGR_PLLSAI1M_Pos)
 ...
 * STM32L47xxx/L48xxx else (2 to 31). Use to set SAI1 clock frequency =
 * f(PLLSAI1) / PLLSAI1P
 *
 * @retval None
 */
...
#define __HAL_RCC_PLLSAI1_DIVQ_CONFIG(__PLLSAI1Q__)                            \
    MODIFY_REG(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1Q,                     \
               (((__PLLSAI1Q__) >> 1U) - 1U) << RCC_PLLSAI1CFGR_PLLSAI1Q_Pos)
...
#define __HAL_RCC_PLLSAI1_DIVR_CONFIG(__PLLSAI1R__)                            \
    MODIFY_REG(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1R,                     \
               (((__PLLSAI1R__) >> 1U) - 1U) << RCC_PLLSAI1CFGR_PLLSAI1R_Pos)
...
#define __HAL_RCC_PLLSAI2_CONFIG(__PLLSAI2M__, __PLLSAI2N__, __PLLSAI2P__,     \
                                 __PLLSAI2Q__, __PLLSAI2R__)                   \
    MODIFY_REG(                                                                \
        RCC->PLLSAI2CFGR,                                                      \
        (RCC_PLLSAI2CFGR_PLLSAI2M | RCC_PLLSAI2CFGR_PLLSAI2N |                 \
         RCC_PLLSAI2CFGR_PLLSAI2P | RCC_PLLSAI2CFGR_PLLSAI2Q |                 \
...
#define __HAL_RCC_PLLSAI2_CONFIG(__PLLSAI2M__, __PLLSAI2N__, __PLLSAI2P__,     \
    ...
    MODIFY_REG(                                                                \
        RCC->PLLSAI2CFGR,                                                      \
        (RCC_PLLSAI2CFGR_PLLSAI2M | RCC_PLLSAI2CFGR_PLLSAI2N |                 \
         RCC_PLLSAI2CFGR_PLLSAI2P | RCC_PLLSAI2CFGR_PLLSAI2R |                 \
...
#define __HAL_RCC_PLLSAI2_CONFIG(__PLLSAI2N__, __PLLSAI2P__, __PLLSAI2Q__,     \
                                 __PLLSAI2R__)                                 \
    MODIFY_REG(                                                                \
        RCC->PLLSAI2CFGR,                                                      \
        (RCC_PLLSAI2CFGR_PLLSAI2N | RCC_PLLSAI2CFGR_PLLSAI2P |                 \
         RCC_PLLSAI2CFGR_PLLSAI2Q | RCC_PLLSAI2CFGR_PLLSAI2R |                 \
         RCC_PLLSAI2CFGR_PLLSAI2PDIV),                                         \
        (((__PLLSAI2N__) << RCC_PLLSAI2CFGR_PLLSAI2N_Pos) |                    \
         ((((__PLLSAI2Q__) >> 1U) - 1U) << RCC_PLLSAI2CFGR_PLLSAI2Q_Pos) |     \
         ((((__PLLSAI2R__) >> 1U) - 1U) << RCC_PLLSAI2CFGR_PLLSAI2R_Pos) |     \
...
#define __HAL_RCC_PLLSAI2_DIVM_CONFIG(__PLLSAI2M__)                            \
    MODIFY_REG(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2M,                     \
               ((__PLLSAI2M__)-1U) << RCC_PLLSAI2CFGR_PLLSAI2M_Pos)
...
#define __HAL_RCC_PLLSAI2_DIVP_CONFIG(__PLLSAI2P__)                            \
    MODIFY_REG(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2P,                     \
               ((__PLLSAI2P__) >> 4U) << RCC_PLLSAI2CFGR_PLLSAI2P_Pos)
...
#define __HAL_RCC_PLLSAI2_DIVQ_CONFIG(__PLLSAI2Q__)                            \
    MODIFY_REG(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2Q,                     \
               (((__PLLSAI2Q__) >> 1U) - 1U) << RCC_PLLSAI2CFGR_PLLSAI2Q_Pos)
...
#define __HAL_RCC_PLLSAI2_DIVR_CONFIG(__PLLSAI2R__)                            \
    MODIFY_REG(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2R,                     \
               (((__PLLSAI2R__) >> 1U) - 1U) << RCC_PLLSAI2CFGR_PLLSAI2R_Pos)
...
#define __HAL_RCC_PLLSAI2CLKOUT_ENABLE(__PLLSAI2_CLOCKOUT__)                   \
    SET_BIT(RCC->PLLSAI2CFGR, (__PLLSAI2_CLOCKOUT__))

#define __HAL_RCC_PLLSAI2CLKOUT_DISABLE(__PLLSAI2_CLOCKOUT__)                  \
    CLEAR_BIT(RCC->PLLSAI2CFGR, (__PLLSAI2_CLOCKOUT__))
...
/**
  ...
  * @retval SET / RESET
  */
#define __HAL_RCC_GET_PLLSAI2CLKOUT_CONFIG(__PLLSAI2_CLOCKOUT__)               \
    READ_BIT(RCC->PLLSAI2CFGR, (__PLLSAI2_CLOCKOUT__))
 ...
 * @retval The clock source can be one of the following values:
 *             @arg @ref RCC_SAI2CLKSOURCE_PLLSAI1  SAI2 clock = PLLSAI1 "P"
 * clock (PLLSAI1CLK)
 *             @arg @ref RCC_SAI2CLKSOURCE_PLLSAI2  SAI2 clock = PLLSAI2 "P"
 * clock (PLLSAI2CLK)
 *             @arg @ref RCC_SAI2CLKSOURCE_PLL  SAI2 clock  = PLL "P" clock
 * (PLLSAI3CLK)
 *             @arg @ref RCC_SAI2CLKSOURCE_PIN  SAI2 clock = External Clock
 * (SAI2_EXTCLK)
 */
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) ||    \
    defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) ||    \
 ...
 * @retval The clock source can be one of the following values:
 *            @arg @ref RCC_LPTIM2CLKSOURCE_PCLK1  PCLK1 selected as LPUART1
 * clock
 *            @arg @ref RCC_LPTIM2CLKSOURCE_LSI  HSI selected as LPUART1 clock
 *            @arg @ref RCC_LPTIM2CLKSOURCE_HSI  System Clock selected as
 * LPUART1 clock
...
#define __HAL_RCC_GET_SDMMC1_SOURCE()                                          \
    ((READ_BIT(RCC->CCIPR2, RCC_CCIPR2_SDMMCSEL) != 0U)                        \
...
#define __HAL_RCC_GET_ADC_SOURCE()                                             \
    ((__HAL_RCC_ADC_IS_CLK_ENABLED() != 0U) ? RCC_ADCCLKSOURCE_SYSCLK          \
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_SWPMI1CLKSOURCE_PCLK1  PCLK1 Clock selected as
 * SWPMI1 clock
 *            @arg @ref RCC_SWPMI1CLKSOURCE_HSI  HSI Clock selected as SWPMI1
 * clock
 * @retval None
 */
...
#define __HAL_RCC_GET_SWPMI1_SOURCE()                                          \
    (READ_BIT(RCC->CCIPR, RCC_CCIPR_SWPMI1SEL))
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_DFSDM1CLKSOURCE_PCLK2  PCLK2 Clock selected as
 * DFSDM1 clock
 *            @arg @ref RCC_DFSDM1CLKSOURCE_SYSCLK  System Clock selected as
 * DFSDM1 clock
 * @retval None
 */
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) ||    \
...
#else
#define __HAL_RCC_GET_DFSDM1_SOURCE()                                          \
    (READ_BIT(RCC->CCIPR, RCC_CCIPR_DFSDM1SEL))
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx ||          \
          STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_DFSDM1AUDIOCLKSOURCE_SAI1  SAI1 clock selected as
 * DFSDM1 audio clock
 *            @arg @ref RCC_DFSDM1AUDIOCLKSOURCE_HSI   HSI clock selected as
 * DFSDM1 audio clock
 *            @arg @ref RCC_DFSDM1AUDIOCLKSOURCE_MSI   MSI clock selected as
 * DFSDM1 audio clock
 * @retval None
 */
...
#define __HAL_RCC_GET_DFSDM1AUDIO_SOURCE()                                     \
    (READ_BIT(RCC->CCIPR2, RCC_CCIPR2_ADFSDM1SEL))
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV2   PLLSAI2 divider R
 * divided by 2 clock selected as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV4   PLLSAI2 divider R
 * divided by 4 clock selected as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV8   PLLSAI2 divider R
 * divided by 8 clock selected as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV16  PLLSAI2 divider R
 * divided by 16 clock selected as LTDC clock
 * @retval None
 */
 ...
 * divided by 16 clock selected as LTDC clock
 */
#define __HAL_RCC_GET_LTDC_SOURCE()                                            \
    (READ_BIT(RCC->CCIPR2, RCC_CCIPR2_PLLSAI2DIVR))
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_DSICLKSOURCE_DSIPHY  DSI-PHY clock selected as DSI
 * clock
 *            @arg @ref RCC_DSICLKSOURCE_PLLSAI2 PLLSAI2 R divider clock
 * selected as DSI clock
 * @retval None
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_OSPICLKSOURCE_SYSCLK  System Clock selected as
 * OctoSPI clock
 *            @arg @ref RCC_OSPICLKSOURCE_MSI     MSI clock selected as OctoSPI
 * clock
 *            @arg @ref RCC_OSPICLKSOURCE_PLL     PLL Q divider clock selected
 * as OctoSPI clock
 * @retval None
 */
 ...
 * @retval None
 */
#define __HAL_RCC_PLLSAI1_DISABLE_IT()                                         \
 ...
 */
#define __HAL_RCC_PLLSAI1_GET_IT_SOURCE()                                      \
    (READ_BIT(RCC->CIFR, RCC_CIFR_PLLSAI1RDYF) == RCC_CIFR_PLLSAI1RDYF)

/** @brief  Check whether the PLLSAI1RDY flag is set or not.
 * @retval TRUE or FALSE.
 */
#define __HAL_RCC_PLLSAI1_GET_FLAG()                                           \
    (READ_BIT(RCC->CR, RCC_CR_PLLSAI1RDY) == (RCC_CR_PLLSAI1RDY))
 ...
 * @retval None
 */
#define __HAL_RCC_PLLSAI2_DISABLE_IT()                                         \
 ...
 * @retval TRUE or FALSE.
 */
#define __HAL_RCC_PLLSAI2_GET_IT_SOURCE()                                      \
    (READ_BIT(RCC->CIFR, RCC_CIFR_PLLSAI2RDYF) == RCC_CIFR_PLLSAI2RDYF)

/** @brief  Check whether the PLLSAI2RDY flag is set or not.
 * @retval TRUE or FALSE.
 */
#define __HAL_RCC_PLLSAI2_GET_FLAG()                                           \
    (READ_BIT(RCC->CR, RCC_CR_PLLSAI2RDY) == (RCC_CR_PLLSAI2RDY))
...
#define __HAL_RCC_CRS_CLEAR_IT(__INTERRUPT__)                                  \
    do {                                                                       \
        if (((__INTERRUPT__)&RCC_CRS_IT_ERROR_MASK) != 0U) {                   \
            WRITE_REG(CRS->ICR, CRS_ICR_ERRC | ((__INTERRUPT__) &              \
 ...
 *             of the synchronization source after prescaling. It is then
 * decreased by one in order to reach the expected synchronization on the zero
 * value. The formula is the following: RELOAD = (fTARGET / fSYNC) -1
...
#define __HAL_RCC_PSSI_IS_CLK_SLEEP_ENABLED()                                  \
    __HAL_RCC_DCMI_IS_CLK_SLEEP_ENABLED()

#define __HAL_RCC_PSSI_IS_CLK_SLEEP_DISABLED()                                 \
...
#define RCC_PERIPHCLOCK_ALL                                                    \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 |      \
     RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 |         \
     RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 |        \
     RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 |           \
...
#define RCC_PERIPHCLOCK_ALL                                                    \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 |      \
     RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 |         \
     RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 |        \
     RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC |              \
...
#define RCC_PERIPHCLOCK_ALL                                                    \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 |      \
     ...
     RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_SDMMC1)
...
#define RCC_PERIPHCLOCK_ALL                                                    \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 |      \
     ...
     RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 |            \
     RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 |        \
     RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC |              \
...
#if defined(RCC_PLLSAI1M_DIV_1_16_SUPPORT)
#define IS_RCC_PLLSAI1M_VALUE(__VALUE__)                                       \
...
#define IS_RCC_PLLSAI1N_VALUE(__VALUE__)                                       \
...
#if defined(RCC_PLLSAI2M_DIV_1_16_SUPPORT)
#define IS_RCC_PLLSAI2M_VALUE(__VALUE__)                                       \
    ((1U <= (__VALUE__)) && ((__VALUE__) <= 16U))
#else
#define IS_RCC_PLLSAI2M_VALUE(__VALUE__)                                       \
    ((1U <= (__VALUE__)) && ((__VALUE__) <= 8U))
...
#define IS_RCC_PLLSAI2P_VALUE(__VALUE__)                                       \
    (((__VALUE__) >= 2U) && ((__VALUE__) <= 31U))
#else
#define IS_RCC_PLLSAI2P_VALUE(__VALUE__)                                       \
    (((__VALUE__) == 7U) || ((__VALUE__) == 17U))
...
#if defined(RCC_PLLSAI2Q_DIV_SUPPORT)
#define IS_RCC_PLLSAI2Q_VALUE(__VALUE__)                                       \
    (((__VALUE__) == 2U) || ((__VALUE__) == 4U) || ((__VALUE__) == 6U) ||      \
     ((__VALUE__) == 8U))
#endif /* RCC_PLLSAI2Q_DIV_SUPPORT */
