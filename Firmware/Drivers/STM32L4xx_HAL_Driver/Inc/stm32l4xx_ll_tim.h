...
#if defined(TIM1) || defined(TIM8) || defined(TIM2) || defined(TIM3) ||        \
    defined(TIM4) || defined(TIM5) || defined(TIM15) || defined(TIM16) ||      \
    defined(TIM17) || defined(TIM6) || defined(TIM7)
...
#if defined(ADC3)
#define TIM1_OR1_RMP_MASK                                                      \
    ((TIM1_OR1_ETR_ADC1_RMP | TIM1_OR1_ETR_ADC3_RMP | TIM1_OR1_TI1_RMP)        \
     << TIMx_OR1_RMP_SHIFT)
#else
#define TIM1_OR1_RMP_MASK                                                      \
    ((TIM1_OR1_ETR_ADC1_RMP | TIM1_OR1_TI1_RMP) << TIMx_OR1_RMP_SHIFT)
#endif /* ADC3 */
#define TIM2_OR1_RMP_MASK                                                      \
    ((TIM2_OR1_TI4_RMP | TIM2_OR1_ETR1_RMP | TIM2_OR1_ITR1_RMP)                \
     << TIMx_OR1_RMP_SHIFT)
#define TIM3_OR1_RMP_MASK (TIM3_OR1_TI1_RMP << TIMx_OR1_RMP_SHIFT)
#if defined(ADC2) && defined(ADC3)
#define TIM8_OR1_RMP_MASK                                                      \
    ((TIM8_OR1_ETR_ADC2_RMP | TIM8_OR1_ETR_ADC3_RMP | TIM8_OR1_TI1_RMP)        \
     << TIMx_OR1_RMP_SHIFT)
#else
...
typedef struct {
    ...
    uint32_t
        CompareValue; /*!< Specifies the Compare value to be loaded into the Capture Compare Register.
                           This parameter can be a number between Min_Data=0x0000 and Max_Data=0xFFFF.
    ...
    uint32_t
        OCIdleState; /*!< Specifies the TIM Output Compare pin state during Idle state.
...
typedef struct {
    ...
    uint32_t
        ICActiveInput; /*!< Specifies the input.
...
typedef struct {
    ...
    uint32_t
        IC1ActiveInput; /*!< Specifies the TI1 input source
                             This parameter can be a value of @ref TIM_LL_EC_ACTIVEINPUT.
    ...
    uint32_t
        IC2ActiveInput; /*!< Specifies the TI2 input source
                             This parameter can be a value of @ref TIM_LL_EC_ACTIVEINPUT.
...
typedef struct {
    ...
    uint32_t
        CommutationDelay; /*!< Specifies the compare value to be loaded into the Capture Compare Register.
...
typedef struct {
    ...
    uint32_t
        BreakFilter; /*!< Specifies the TIM Break Filter.
    ...
    uint32_t
        Break2State; /*!< Specifies whether the TIM Break2 input is enabled or not.
    ...
    uint32_t
        Break2Polarity; /*!< Specifies the TIM Break2 Input pin polarity.
    ...
    uint32_t
        Break2Filter; /*!< Specifies the TIM Break2 Filter.
...
#define LL_TIM_UPDATESOURCE_REGULAR                                            \
    0x00000000U /*!< Counter overflow/underflow, Setting the UG bit or Update generation through the slave mode controller generates an update request */
...
#define LL_TIM_CCUPDATESOURCE_COMG_AND_TRGI                                    \
    TIM_CR2_CCUS /*!< Capture/compare control bits are updated by setting the COMG bit or when a rising edge occurs on trigger input (TRGI) */
/**
 * @}
 */
...
#define LL_TIM_OCMODE_FROZEN                                                   \
    0x00000000U /*!<The comparison between the output compare register TIMx_CCRy and the counter TIMx_CNT has no effect on the output channel level */
...
#define LL_TIM_OCMODE_PWM1                                                     \
    (TIM_CCMR1_OC1M_2 |                                                        \
     TIM_CCMR1_OC1M_1) /*!<In upcounting, channel y is active as long as TIMx_CNT<TIMx_CCRy else inactive.  In downcounting, channel y is inactive as long as TIMx_CNT>TIMx_CCRy else active.*/
#define LL_TIM_OCMODE_PWM2                                                     \
    (TIM_CCMR1_OC1M_2 | TIM_CCMR1_OC1M_1 |                                     \
     TIM_CCMR1_OC1M_0) /*!<In upcounting, channel y is inactive as long as TIMx_CNT<TIMx_CCRy else active.  In downcounting, channel y is active as long as TIMx_CNT>TIMx_CCRy else inactive*/
...
#define LL_TIM_IC_POLARITY_BOTHEDGE                                            \
    (TIM_CCER_CC1P |                                                           \
     TIM_CCER_CC1NP) /*!< The circuit is sensitive to both TIxFP1 rising and falling edges, TIxFP1 is not inverted */
/**
 * @}
 */
...
#define LL_TIM_ENCODERMODE_X2_TI1                                              \
    TIM_SMCR_SMS_0 /*!< Quadrature encoder mode 1, x2 mode - Counter counts up/down on TI1FP1 edge depending on TI2FP2 level */
#define LL_TIM_ENCODERMODE_X2_TI2                                              \
    TIM_SMCR_SMS_1 /*!< Quadrature encoder mode 2, x2 mode - Counter counts up/down on TI2FP2 edge depending on TI1FP1 level */
#define LL_TIM_ENCODERMODE_X4_TI12                                             \
    (TIM_SMCR_SMS_1 |                                                          \
     TIM_SMCR_SMS_0) /*!< Quadrature encoder mode 3, x4 mode - Counter counts up/down on both TI1FP1 and TI2FP2 edges depending on the level of the other input */
/**
 * @}
 */
...
#define LL_TIM_SLAVEMODE_TRIGGER                                               \
    (TIM_SMCR_SMS_2 |                                                          \
     TIM_SMCR_SMS_1) /*!< Trigger Mode - The counter starts at a rising edge of the trigger TRGI */
#define LL_TIM_SLAVEMODE_COMBINED_RESETTRIGGER                                 \
    TIM_SMCR_SMS_3 /*!< Combined reset + trigger mode - Rising edge of the selected trigger input (TRGI)  reinitializes the counter, generates an update of the registers and starts the counter */
/**
 * @}
 */
...
#define LL_TIM_ETRSOURCE_COMP1                                                 \
    TIM1_OR2_ETRSEL_0 /*!< COMP1 output connected to ETR input */
#define LL_TIM_ETRSOURCE_COMP2                                                 \
    TIM1_OR2_ETRSEL_1 /*!< COMP2 output connected to ETR input */
/**
 * @}
 */
...
#define LL_TIM_OSSI_ENABLE                                                     \
    TIM_BDTR_OSSI /*!< When inactive, OxC/OCxN outputs are first forced with their inactive level then forced to their idle level after the deadtime */
/**
 * @}
 */
...
#define LL_TIM_OSSR_ENABLE                                                     \
    TIM_BDTR_OSSR /*!< When inactive, OC/OCN outputs are enabled with their inactive level as soon as CCxE=1 or CCxNE=1 */
/**
 * @}
 */
...
#define LL_TIM_BKIN_SOURCE_BKIN                                                \
    TIM1_OR2_BKINE /*!< BKIN input from AF controller */
#define LL_TIM_BKIN_SOURCE_BKCOMP1                                             \
    TIM1_OR2_BKCMP1E /*!< internal signal: COMP1 output */
#define LL_TIM_BKIN_SOURCE_BKCOMP2                                             \
    TIM1_OR2_BKCMP2E /*!< internal signal: COMP2 output */
#if defined(DFSDM1_Channel0)
#define LL_TIM_BKIN_SOURCE_DF1BK                                               \
    TIM1_OR2_BKDF1BK0E /*!< internal signal: DFSDM1 break output */
#endif                 /* DFSDM1_Channel0 */
/**
 * @}
 */
...
#define LL_TIM_BKIN_POLARITY_LOW                                               \
    TIM1_OR2_BKINP /*!< BRK BKIN input is active low */
...
#define LL_TIM_DMABURST_BASEADDR_OR1                                           \
    (TIM_DCR_DBA_4 |                                                           \
     TIM_DCR_DBA_2) /*!< TIMx_OR1 register is the DMA base address for DMA burst */
...
#define LL_TIM_DMABURST_BASEADDR_OR2                                           \
    (TIM_DCR_DBA_4 |                                                           \
     TIM_DCR_DBA_3) /*!< TIMx_OR2 register is the DMA base address for DMA burst */
#define LL_TIM_DMABURST_BASEADDR_OR3                                           \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_3 |                                           \
     TIM_DCR_DBA_0) /*!< TIMx_OR3 register is the DMA base address for DMA burst */
/**
 * @}
 */
...
#define LL_TIM_DMABURST_LENGTH_4TRANSFERS                                      \
    (TIM_DCR_DBL_1 |                                                           \
     TIM_DCR_DBL_0) /*!< Transfer is done to 4 registers starting from the DMA burst base address */
...
#define LL_TIM_DMABURST_LENGTH_6TRANSFERS                                      \
    (TIM_DCR_DBL_2 |                                                           \
     TIM_DCR_DBL_0) /*!< Transfer is done to 6 registers starting from the DMA burst base address */
#define LL_TIM_DMABURST_LENGTH_7TRANSFERS                                      \
    (TIM_DCR_DBL_2 |                                                           \
     TIM_DCR_DBL_1) /*!< Transfer is done to 7 registers starting from the DMA burst base address */
...
#define LL_TIM_DMABURST_LENGTH_10TRANSFERS                                     \
    (TIM_DCR_DBL_3 |                                                           \
     TIM_DCR_DBL_0) /*!< Transfer is done to 10 registers starting from the DMA burst base address */
#define LL_TIM_DMABURST_LENGTH_11TRANSFERS                                     \
    (TIM_DCR_DBL_3 |                                                           \
     TIM_DCR_DBL_1) /*!< Transfer is done to 11 registers starting from the DMA burst base address */
...
#define LL_TIM_DMABURST_LENGTH_13TRANSFERS                                     \
    (TIM_DCR_DBL_3 |                                                           \
     TIM_DCR_DBL_2) /*!< Transfer is done to 13 registers starting from the DMA burst base address */
...
#define LL_TIM_DMABURST_LENGTH_18TRANSFERS                                     \
    (TIM_DCR_DBL_4 |                                                           \
     TIM_DCR_DBL_0) /*!< Transfer is done to 18 registers starting from the DMA burst base address */
/**
 * @}
 */
...
#define LL_TIM_TIM1_ETR_ADC1_RMP_NC                                            \
    TIM1_OR1_RMP_MASK /*!< TIM1_ETR is not connected to ADC1 analog watchdog x */
#define LL_TIM_TIM1_ETR_ADC1_RMP_AWD1                                          \
    (TIM1_OR1_ETR_ADC1_RMP_0 |                                                 \
     TIM1_OR1_RMP_MASK) /*!< TIM1_ETR is connected to ADC1 analog watchdog 1 */
#define LL_TIM_TIM1_ETR_ADC1_RMP_AWD2                                          \
    (TIM1_OR1_ETR_ADC1_RMP_1 |                                                 \
     TIM1_OR1_RMP_MASK) /*!< TIM1_ETR is connected to ADC1 analog watchdog 2 */
#define LL_TIM_TIM1_ETR_ADC1_RMP_AWD3                                          \
    (TIM1_OR1_ETR_ADC1_RMP |                                                   \
     TIM1_OR1_RMP_MASK) /*!< TIM1_ETR is connected to ADC1 analog watchdog 3 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_TIM_TIM1_ETR_ADC3_RMP_NC                                            \
    TIM1_OR1_RMP_MASK /*!< TIM1_ETR is not connected to ADC3 analog watchdog  x*/
#define LL_TIM_TIM1_ETR_ADC3_RMP_AWD1                                          \
    (TIM1_OR1_ETR_ADC3_RMP_0 |                                                 \
     TIM1_OR1_RMP_MASK) /*!< TIM1_ETR is connected to ADC3 analog watchdog 1 */
#define LL_TIM_TIM1_ETR_ADC3_RMP_AWD2                                          \
    (TIM1_OR1_ETR_ADC3_RMP_1 |                                                 \
     TIM1_OR1_RMP_MASK) /*!< TIM1_ETR is connected to ADC3 analog watchdog 2 */
#define LL_TIM_TIM1_ETR_ADC3_RMP_AWD3                                          \
    (TIM1_OR1_ETR_ADC3_RMP |                                                   \
     TIM1_OR1_RMP_MASK) /*!< TIM1_ETR is connected to ADC3 analog watchdog 3 */
/**
 * @}
 */
#endif /* ADC3 */
...
#define LL_TIM_TIM1_TI1_RMP_GPIO                                               \
    TIM1_OR1_RMP_MASK /*!< TIM1 input capture 1 is connected to GPIO */
#define LL_TIM_TIM1_TI1_RMP_COMP1                                              \
    (TIM1_OR1_TI1_RMP |                                                        \
     TIM1_OR1_RMP_MASK) /*!< TIM1 input capture 1 is connected to COMP1 output */
/**
 * @}
 */
 ...
 */
    ...
    defined(STM32L4S9xx)
#define LL_TIM_TIM2_ITR1_RMP_TIM8_TRGO                                         \
    TIM2_OR1_RMP_MASK /*!< TIM2_ITR1 is connected to TIM8_TRGO */
#define LL_TIM_TIM2_ITR1_RMP_OTG_FS_SOF                                        \
    (TIM2_OR1_ITR1_RMP |                                                       \
     TIM2_OR1_RMP_MASK) /*!< TIM2_ITR1 is connected to OTG_FS SOF */
 ...
 * STM32L4S9xx */
    ...
    defined(STM32L462xx)
#define LL_TIM_TIM2_ITR1_RMP_NONE                                              \
...
#endif /* STM32L431xx || STM32L432xx || STM32L442xx || STM32L433xx ||          \
          STM32L443xx || */
/* STM32L451xx || STM32L452xx || STM32L462xx */
#define LL_TIM_TIM2_ETR_RMP_GPIO                                               \
    TIM2_OR1_RMP_MASK /*!< TIM2_ETR is connected to GPIO */
#define LL_TIM_TIM2_ETR_RMP_LSE                                                \
    (TIM2_OR1_ETR1_RMP |                                                       \
     TIM2_OR1_RMP_MASK) /*!< TIM2_ETR is connected to LSE  */
/**
 * @}
 */
...
#define LL_TIM_TIM2_TI4_RMP_GPIO                                               \
    TIM2_OR1_RMP_MASK /*!< TIM2 input capture 4 is connected to GPIO */
#define LL_TIM_TIM2_TI4_RMP_COMP1                                              \
    (TIM2_OR1_TI4_RMP_0 |                                                      \
     TIM2_OR1_RMP_MASK) /*!< TIM2 input capture 4 is connected to COMP1_OUT */
#if defined(STM32L412xx) || defined(STM32L422xx)
#else
#define LL_TIM_TIM2_TI4_RMP_COMP2                                              \
    (TIM2_OR1_TI4_RMP_1 |                                                      \
     TIM2_OR1_RMP_MASK) /*!< TIM2 input capture 4 is connected to COMP2_OUT */
#define LL_TIM_TIM2_TI4_RMP_COMP1_COMP2                                        \
    (TIM2_OR1_TI4_RMP |                                                        \
     TIM2_OR1_RMP_MASK) /*!< TIM2 input capture 4 is connected to logical OR between COMP1_OUT and COMP2_OUT */
#endif
/**
 * @}
 */
...
#define LL_TIM_TIM3_TI1_RMP_GPIO                                               \
    TIM3_OR1_RMP_MASK /*!< TIM3 input capture 1 is connected to GPIO */
#define LL_TIM_TIM3_TI1_RMP_COMP1                                              \
    (TIM3_OR1_TI1_RMP_0 |                                                      \
     TIM3_OR1_RMP_MASK) /*!< TIM3 input capture 1 is connected to COMP1_OUT */
#define LL_TIM_TIM3_TI1_RMP_COMP2                                              \
    (TIM3_OR1_TI1_RMP_1 |                                                      \
     TIM3_OR1_RMP_MASK) /*!< TIM3 input capture 1 is connected to COMP2_OUT */
#define LL_TIM_TIM3_TI1_RMP_COMP1_COMP2                                        \
    (TIM3_OR1_TI1_RMP |                                                        \
     TIM3_OR1_RMP_MASK) /*!< TIM3 input capture 1 is connected to logical OR between COMP1_OUT and COMP2_OUT */
/**
 * @}
 */
#endif /* TIM3 */
 ...
 * @{
 */
#define LL_TIM_TIM8_ETR_ADC2_RMP_NC                                            \
    TIM8_OR1_RMP_MASK /*!< TIM8_ETR is not connected to ADC2 analog watchdog x */
#define LL_TIM_TIM8_ETR_ADC2_RMP_AWD1                                          \
    (TIM8_OR1_ETR_ADC2_RMP_0 |                                                 \
     TIM8_OR1_RMP_MASK) /*!< TIM8_ETR is connected to ADC2 analog watchdog */
#define LL_TIM_TIM8_ETR_ADC2_RMP_AWD2                                          \
    (TIM8_OR1_ETR_ADC2_RMP_1 |                                                 \
     TIM8_OR1_RMP_MASK) /*!< TIM8_ETR is connected to ADC2 analog watchdog 2 */
#define LL_TIM_TIM8_ETR_ADC2_RMP_AWD3                                          \
    (TIM8_OR1_ETR_ADC2_RMP |                                                   \
     TIM8_OR1_RMP_MASK) /*!< TIM8_ETR is connected to ADC2 analog watchdog 3 */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_TIM_TIM8_ETR_ADC3_RMP_NC                                            \
    TIM8_OR1_RMP_MASK /*!< TIM8_ETR is not connected to ADC3 analog watchdog x */
#define LL_TIM_TIM8_ETR_ADC3_RMP_AWD1                                          \
    (TIM8_OR1_ETR_ADC3_RMP_0 |                                                 \
     TIM8_OR1_RMP_MASK) /*!< TIM8_ETR is connected to ADC3 analog watchdog 1 */
#define LL_TIM_TIM8_ETR_ADC3_RMP_AWD2                                          \
    (TIM8_OR1_ETR_ADC3_RMP_1 |                                                 \
     TIM8_OR1_RMP_MASK) /*!< TIM8_ETR is connected to ADC3 analog watchdog 2 */
#define LL_TIM_TIM8_ETR_ADC3_RMP_AWD3                                          \
    (TIM8_OR1_ETR_ADC3_RMP |                                                   \
     TIM8_OR1_RMP_MASK) /*!< TIM8_ETR is connected to ADC3 analog watchdog 3 */
/**
 * @}
 */
...
#define LL_TIM_TIM8_TI1_RMP_GPIO                                               \
    TIM8_OR1_RMP_MASK /*!< TIM8 input capture 1 is connected to GPIO */
#define LL_TIM_TIM8_TI1_RMP_COMP2                                              \
    (TIM8_OR1_TI1_RMP |                                                        \
     TIM8_OR1_RMP_MASK) /*!< TIM8 input capture 1 is connected to COMP2 output */
/**
 * @}
 */
#endif /* TIM8 */
...
#define LL_TIM_TIM15_TI1_RMP_GPIO                                              \
    TIM15_OR1_RMP_MASK /*!< TIM15 input capture 1 is connected to GPIO */
#define LL_TIM_TIM15_TI1_RMP_LSE                                               \
    (TIM15_OR1_TI1_RMP |                                                       \
     TIM15_OR1_RMP_MASK) /*!< TIM15 input capture 1 is connected to LSE */
/**
 * @}
 */
...
#define LL_TIM_TIM15_ENCODERMODE_NOREDIRECTION                                 \
    TIM15_OR1_RMP_MASK /*!< No redirection*/
#define LL_TIM_TIM15_ENCODERMODE_TIM2                                          \
    (TIM15_OR1_ENCODER_MODE_0 |                                                \
     TIM15_OR1_RMP_MASK) /*!< TIM2 IC1 and TIM2 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively */
#define LL_TIM_TIM15_ENCODERMODE_TIM3                                          \
    (TIM15_OR1_ENCODER_MODE_1 |                                                \
     TIM15_OR1_RMP_MASK) /*!< TIM3 IC1 and TIM3 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectivel y*/
#define LL_TIM_TIM15_ENCODERMODE_TIM4                                          \
    (TIM15_OR1_ENCODER_MODE |                                                  \
     TIM15_OR1_RMP_MASK) /*!< TIM4 IC1 and TIM4 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively */
/**
 * @}
 */
...
#define LL_TIM_TIM16_TI1_RMP_GPIO                                              \
    TIM16_OR1_RMP_MASK /*!< TIM16 input capture 1 is connected to GPIO */
#define LL_TIM_TIM16_TI1_RMP_LSI                                               \
    (TIM16_OR1_TI1_RMP_0 |                                                     \
     TIM16_OR1_RMP_MASK) /*!< TIM16 input capture 1 is connected to LSI */
#define LL_TIM_TIM16_TI1_RMP_LSE                                               \
    (TIM16_OR1_TI1_RMP_1 |                                                     \
     TIM16_OR1_RMP_MASK) /*!< TIM16 input capture 1 is connected to LSE */
#define LL_TIM_TIM16_TI1_RMP_RTC                                               \
    (TIM16_OR1_TI1_RMP_1 | TIM16_OR1_TI1_RMP_0 |                               \
     TIM16_OR1_RMP_MASK) /*!< TIM16 input capture 1 is connected to RTC wakeup interrupt */
#if defined TIM16_OR1_TI1_RMP_2
#define LL_TIM_TIM16_TI1_RMP_MSI                                               \
    (TIM16_OR1_TI1_RMP_2 |                                                     \
     TIM16_OR1_RMP_MASK) /*!< TIM16 input capture 1 is connected to MSI */
#define LL_TIM_TIM16_TI1_RMP_HSE_32                                            \
    (TIM16_OR1_TI1_RMP_2 | TIM16_OR1_TI1_RMP_0 |                               \
     TIM16_OR1_RMP_MASK) /*!< TIM16 input capture 1 is connected to HSE/32 */
#define LL_TIM_TIM16_TI1_RMP_MCO                                               \
    (TIM16_OR1_TI1_RMP_2 | TIM16_OR1_TI1_RMP_1 |                               \
     TIM16_OR1_RMP_MASK) /*!< TIM16 input capture 1 is connected to MCO */
#endif
/**
 * @}
 */
...
#define LL_TIM_TIM17_TI1_RMP_GPIO                                              \
    TIM17_OR1_RMP_MASK /*!< TIM17 input capture 1 is connected to GPIO */
#define LL_TIM_TIM17_TI1_RMP_MSI                                               \
    (TIM17_OR1_TI1_RMP_0 |                                                     \
     TIM17_OR1_RMP_MASK) /*!< TIM17 input capture 1 is connected to MSI */
#define LL_TIM_TIM17_TI1_RMP_HSE_32                                            \
    (TIM17_OR1_TI1_RMP_1 |                                                     \
     TIM17_OR1_RMP_MASK) /*!< TIM17 input capture 1 is connected to HSE/32 */
#define LL_TIM_TIM17_TI1_RMP_MCO                                               \
    (TIM17_OR1_TI1_RMP |                                                       \
     TIM17_OR1_RMP_MASK) /*!< TIM17 input capture 1 is connected to MCO */
/**
 * @}
 */
#endif /* TIM17 */
 ...
 * @{
 */
#define LL_TIM_OCREF_CLR_INT_NC                                                \
    0x00000000U /*!< OCREF_CLR_INT is not connected */
...
#define __LL_TIM_CALC_PSC(__TIMCLK__, __CNTCLK__)                              \
    (((__TIMCLK__) >= (__CNTCLK__))                                            \
         ? (uint32_t)((((__TIMCLK__) + (__CNTCLK__) / 2U) / (__CNTCLK__)) -    \
                      1U)                                                      \
         : 0U)
                                                ...
                                                uint32_t           Channel)
{
    ...
    const __IO uint32_t *pReg     = (__IO uint32_t *)((
        uint32_t)((uint32_t)(&TIMx->CCMR1) + OFFSET_TAB_CCMRx[iChannel]));
    return (
        (READ_BIT(*pReg, ((TIM_CCMR1_IC1PSC) << SHIFT_TAB_ICxx[iChannel])) >>
         SHIFT_TAB_ICxx[iChannel])
        << 16U);
}
...
{
    MODIFY_REG(TIMx->BDTR, TIM_BDTR_BKP | TIM_BDTR_BKF,
               BreakPolarity | BreakFilter);
}
...
{
    MODIFY_REG(TIMx->BDTR, TIM_BDTR_BK2P | TIM_BDTR_BK2F,
...
{
    __IO uint32_t *pReg =
        (__IO uint32_t *)((uint32_t)((uint32_t)(&TIMx->OR2) + BreakInput));
    SET_BIT(*pReg, Source);
}
                                                        ...
                                                        uint32_t     Polarity)
{
    __IO uint32_t *pReg =
        (__IO uint32_t *)((uint32_t)((uint32_t)(&TIMx->OR2) + BreakInput));
    MODIFY_REG(*pReg, (TIMx_OR2_BKINP << TIM_POSITION_BRK_SOURCE),
...
{
    MODIFY_REG(TIMx->OR1, (Remap >> TIMx_OR1_RMP_SHIFT),
               (Remap & TIMx_OR1_RMP_MASK));
}
...
LL_TIM_SetOCRefClearInputSource(TIM_TypeDef *TIMx,
...
#endif /* TIM1 || TIM8 || TIM2 || TIM3 ||  TIM4 || TIM5 || TIM15 || TIM16 ||   \
          TIM17 || TIM6 || TIM7 */
