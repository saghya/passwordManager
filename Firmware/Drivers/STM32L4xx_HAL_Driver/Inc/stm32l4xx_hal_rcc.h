...
typedef struct {
    ...
    uint32_t
        PLLSource; /*!< RCC_PLLSource: PLL entry clock source.
                        This parameter must be a value of @ref RCC_PLL_Clock_Source               */

    uint32_t
        PLLM; /*!< PLLM: Division factor for PLL VCO input clock.
    ...
    uint32_t
        PLLN; /*!< PLLN: Multiplication factor for PLL VCO output clock.
                   This parameter must be a number between Min_Data = 8 and Max_Data = 86    */

#if defined(RCC_PLLP_SUPPORT)
    uint32_t
        PLLP; /*!< PLLP: Division factor for SAI clock.
                   This parameter must be a value of @ref RCC_PLLP_Clock_Divider             */
#endif        /* RCC_PLLP_SUPPORT */

    uint32_t
        PLLQ; /*!< PLLQ: Division factor for SDMMC1, RNG and USB clocks.
...
typedef struct {
    uint32_t
        OscillatorType; /*!< The oscillators to be configured.
    ...
    uint32_t
        HSICalibrationValue; /*!< The calibration trimming value (default is RCC_HSICALIBRATION_DEFAULT).
    ...
    uint32_t
        MSIState; /*!< The new state of the MSI.
                       This parameter can be a value of @ref RCC_MSI_Config */

    uint32_t
        MSICalibrationValue; /*!< The calibration trimming value (default is RCC_MSICALIBRATION_DEFAULT).
                                  This parameter must be a number between Min_Data = 0x00 and Max_Data = 0xFF */

    uint32_t
        MSIClockRange; /*!< The MSI frequency range.
                            This parameter can be a value of @ref RCC_MSI_Clock_Range  */

    uint32_t
        HSI48State; /*!< The new state of the HSI48 (only applicable to STM32L43x/STM32L44x/STM32L49x/STM32L4Ax devices).
                         This parameter can be a value of @ref RCC_HSI48_Config */

    RCC_PLLInitTypeDef
        PLL; /*!< Main PLL structure parameters                                               */
...
typedef struct {
    ...
    uint32_t
        SYSCLKSource; /*!< The clock source used as system clock (SYSCLK).
                           This parameter can be a value of @ref RCC_System_Clock_Source    */

    uint32_t
        AHBCLKDivider; /*!< The AHB clock (HCLK) divider. This clock is derived from the system clock (SYSCLK).
                            This parameter can be a value of @ref RCC_AHB_Clock_Source       */

    uint32_t
        APB1CLKDivider; /*!< The APB1 clock (PCLK1) divider. This clock is derived from the AHB clock (HCLK).
                             This parameter can be a value of @ref RCC_APB1_APB2_Clock_Source */

    uint32_t
        APB2CLKDivider; /*!< The APB2 clock (PCLK2) divider. This clock is derived from the AHB clock (HCLK).
                             This parameter can be a value of @ref RCC_APB1_APB2_Clock_Source */
...
#define RCC_LSE_ON_RTC_ONLY                                                    \
    (RCC_BDCR_LSESYSDIS |                                                      \
     RCC_BDCR_LSEON) /*!< LSE clock activation without propagation to system */
#define RCC_LSE_BYPASS_RTC_ONLY                                                \
    (RCC_BDCR_LSEBYP | RCC_BDCR_LSESYSDIS |                                    \
     RCC_BDCR_LSEON) /*!< External clock source for LSE clock without propagation to system */
...
#define RCC_HSICALIBRATION_DEFAULT                                             \
    0x40U /*!< Default HSI calibration trimming value 64 on devices other than STM32L43x/STM32L44x/STM32L47x/STM32L48x */
#else
#define RCC_HSICALIBRATION_DEFAULT                                             \
    0x10U /*!< Default HSI calibration trimming value 16 on STM32L43x/STM32L44x/STM32L47x/STM32L48x devices */
...
#define RCC_PLL_SAI3CLK                                                        \
    RCC_PLLCFGR_PLLPEN /*!< PLLSAI3CLK selection from main PLL (for devices with PLLSAI2) */
#elif defined(RCC_PLLSAI1_SUPPORT)
#define RCC_PLL_SAI2CLK                                                        \
    RCC_PLLCFGR_PLLPEN /*!< PLLSAI2CLK selection from main PLL (for devices without PLLSAI2) */
...
#define RCC_MCO1SOURCE_HSI48                                                   \
    RCC_CFGR_MCOSEL_3 /*!< HSI48 selection as MCO1 source (STM32L43x/STM32L44x devices) */
#endif                /* RCC_HSI48_SUPPORT */
/**
 * @}
 */
...
#define RCC_FLAG_PLLSAI2RDY                                                    \
    ((CR_REG_INDEX << 5U) | RCC_CR_PLLSAI2RDY_Pos) /*!< PLLSAI2 Ready flag */
#endif                                             /* RCC_PLLSAI2_SUPPORT */
 ...
 *         you have to select another source of the system clock then stop the
 * HSI.
 ...
 *         This parameter must be a number between 0 and 31 on
 * STM32L43x/STM32L44x/STM32L47x/STM32L48x or between 0 and 127 on other
 * devices.
 * @retval None
 */
 ...
 *           in parallel to the Internal Multi Speed oscillator (MSI) used at
 * system wakeup.
 ...
 *           in STOP mode to be quickly available as kernel clock for USARTs and
 * I2Cs.
 ...
 *           frequencies, the one that was used before entering stop mode) or
 * HSI. After Standby its frequency can be selected between 4 possible values
 *          (1, 2, 4 or 8 MHz).
 ...
 *            @arg @ref RCC_MSIRANGE_6  MSI clock is around 4 MHz (default after
 * Reset)
 ...
 *         software should wait on HSERDY flag to be set indicating that HSE
 ...
 *         software should wait on LSERDY flag to be set indicating that LSE
 ...
 *            @arg @ref RCC_PLLSOURCE_MSI  MSI oscillator clock selected as PLL
 * clock entry
 ...
 * 16 on STM32L4Rx/STM32L4Sx devices. This parameter must be a number between
 * Min_Data = 1 and Max_Data = 8 on other devices.
 * @note   You have to set the PLLM parameter correctly to ensure that the VCO input
 *         frequency ranges from 4 to 16 MHz. It is recommended to select a
 ...
 * STM32L47x/STM32L48x else (2 to 31).
 *
 ...
 *         without the need to stop the PLL in order to save power. But
 * RCC_PLL_SYSCLK cannot be stopped if used as System Clock.
 * @param  __PLLCLOCKOUT__ specifies the PLL clock to be output.
 *          This parameter can be one or a combination of the following values:
 *            @arg @ref RCC_PLL_SAI3CLK  This clock is used to generate an
 ...
 * clock for the USB OTG FS (48 MHz), the random analog generator (<=48 MHz) and
 * the SDMMC1 (<= 48 MHz).
 ...
 *          This parameter can be one of the following values:
 *              - RCC_SYSCLKSOURCE_MSI: MSI oscillator is used as system clock
 * source.
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_STOP_WAKEUPCLOCK_MSI  MSI selected as system clock
 * source
 *            @arg @ref RCC_STOP_WAKEUPCLOCK_HSI  HSI selected as system clock
 * source
 * @retval None
 */
