...
#define LL_CRS_FREQ_ERROR_DIR_UP                                               \
    ((uint32_t)0x00U) /*!< Upcounting direction, the actual frequency is above the target */
...
LL_CRS_ConfigSynchronization(uint32_t HSI48CalibrationValue,
                             ...
                             uint32_t Settings)
{
    ...
    MODIFY_REG(CRS->CFGR,
               ...
               ReloadValue | (ErrorLimitValue << CRS_CFGR_FELIM_Pos) |
                   Settings);
}
