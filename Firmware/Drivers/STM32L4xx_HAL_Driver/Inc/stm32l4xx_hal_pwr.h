...
typedef struct {
    uint32_t
        PVDLevel; /*!< PVDLevel: Specifies the PVD detection level.
...
#define PWR_PVDLEVEL_7                                                         \
    PWR_CR2_PLS_LEV7 /*!< External input analog voltage (compared internally to VREFINT) */
/**
 * @}
 */
...
#define PWR_EXTI_LINE_PVD                                                      \
    ((uint32_t)0x00010000) /*!< External interrupt line 16 Connected to the PVD EXTI Line */
/**
 * @}
 */
