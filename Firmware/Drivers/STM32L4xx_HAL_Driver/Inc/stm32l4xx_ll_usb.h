...
typedef struct {
    ...
    uint32_t
        Host_channels; /*!< Host Channels number.
                            This parameter Depends on the used USB core.
                            This parameter must be a number between Min_Data = 1 and Max_Data = 15 */
    ...
    uint32_t
        dma_enable; /*!< Enable or disable of the USB embedded DMA used only for OTG HS.        */
    ...
    uint32_t
        use_external_vbus; /*!< Enable or disable the use of the external VBUS.                        */
...
typedef struct {
    ...
    uint8_t
        is_stall; /*!< Endpoint stall condition
                       This parameter must be a number between Min_Data = 0 and Max_Data = 1    */

    uint8_t
        is_iso_incomplete; /*!< Endpoint isoc condition
                                This parameter must be a number between Min_Data = 0 and Max_Data = 1    */
    ...
    uint8_t
        data_pid_start; /*!< Initial data PID
                             This parameter must be a number between Min_Data = 0 and Max_Data = 1    */

    uint8_t
        even_odd_frame; /*!< IFrame parity
                             This parameter must be a number between Min_Data = 0 and Max_Data = 1    */

    uint16_t
        tx_fifo_num; /*!< Transmission FIFO number
                          This parameter must be a number between Min_Data = 1 and Max_Data = 15   */
    ...
    uint32_t
        xfer_size; /*!< requested transfer size                                                  */

    uint32_t
        xfer_count; /*!< Partial transfer length in case of multi packet transfer                 */
} USB_OTG_EPTypeDef;
...
typedef struct {
    ...
    uint8_t
        process_ping; /*!< Execute the PING protocol for HS mode.                                     */
    ...
    uint16_t
        max_packet; /*!< Endpoint Max packet size.
                         This parameter must be a number between Min_Data = 0 and Max_Data = 64KB   */

    uint8_t
        data_pid; /*!< Initial data PID.
                       This parameter must be a number between Min_Data = 0 and Max_Data = 1      */
    ...
    uint8_t
        toggle_out; /*!< OUT transfer current toggle flag
                         This parameter must be a number between Min_Data = 0 and Max_Data = 1      */
...
typedef struct {
    ...
    uint32_t
        low_power_enable; /*!< Enable or disable Low Power mode                                       */

    uint32_t
        lpm_enable; /*!< Enable or disable Battery charging.                                    */

    uint32_t
        battery_charging_enable; /*!< Enable or disable Battery charging.                                    */

    uint32_t
        dma_enable; /*!< dma_enable state unused, DMA not supported by FS instance              */
} USB_CfgTypeDef;
...
typedef struct {
    ...
    uint8_t
        doublebuffer; /*!< Double buffer enable
                           This parameter can be 0 or 1                                              */

    uint16_t
        tx_fifo_num; /*!< This parameter is not required by USB Device FS peripheral, it is used
    ...
    uint32_t
        xfer_len_db; /*!< double buffer transfer length used with bulk double buffer in           */

    uint8_t
        xfer_fill_db; /*!< double buffer Need to Fill new buffer  used with bulk_in                */
...
#define USBx_PCGCCTL                                                           \
    *(__IO uint32_t *)((uint32_t)USBx_BASE + USB_OTG_PCGCCTL_BASE)
#define USBx_HPRT0                                                             \
    *(__IO uint32_t *)((uint32_t)USBx_BASE + USB_OTG_HOST_PORT_BASE)
...
HAL_StatusTypeDef USB_EPClearStall(USB_OTG_GlobalTypeDef *USBx,
                                   USB_OTG_EPTypeDef     *ep);
HAL_StatusTypeDef USB_EPStopXfer(USB_OTG_GlobalTypeDef *USBx,
                                 USB_OTG_EPTypeDef     *ep);
