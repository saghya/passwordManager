...
typedef struct {
    ...
    uint32_t
        PeriphInc; /*!< Specifies whether the Peripheral address register should be incremented or not.
                        This parameter can be a value of @ref DMA_Peripheral_incremented_mode */

    uint32_t
        MemInc; /*!< Specifies whether the memory address register should be incremented or not.
...
typedef struct __DMA_HandleTypeDef {
    ...
    void (*XferAbortCallback)(
        struct __DMA_HandleTypeDef
            *hdma); /*!< DMA transfer abort callback          */
    ...
    DMAMUX_Channel_TypeDef
        *DMAmuxChannel; /*!< Register base address                */

    DMAMUX_ChannelStatus_TypeDef
        *DMAmuxChannelStatus; /*!< DMAMUX Channels Status Base Address  */

    uint32_t
        DMAmuxChannelStatusMask; /*!< DMAMUX Channel Status Mask           */
...
#define IS_DMA_ALL_REQUEST(REQUEST)                                            \
    (((REQUEST) == DMA_REQUEST_0) || ((REQUEST) == DMA_REQUEST_1) ||           \
     ((REQUEST) == DMA_REQUEST_2) || ((REQUEST) == DMA_REQUEST_3) ||           \
     ((REQUEST) == DMA_REQUEST_4) || ((REQUEST) == DMA_REQUEST_5) ||           \
     ((REQUEST) == DMA_REQUEST_6) || ((REQUEST) == DMA_REQUEST_7))
#endif
