...
typedef struct {
    ...
    uint32_t
        AutoReloadPreload; /*!< Specifies the auto-reload preload.
...
typedef struct {
    uint32_t
        OCMode; /*!< Specifies the TIM mode.
                     This parameter can be a value of @ref TIM_Output_Compare_and_PWM_modes */

    uint32_t
        Pulse; /*!< Specifies the pulse value to be loaded into the Capture Compare Register.
                    This parameter can be a number between Min_Data = 0x0000 and Max_Data = 0xFFFF */
...
typedef struct {
    ...
    uint32_t
        ICSelection; /*!< Specifies the input.
...
typedef struct {
    ...
    uint32_t
        IC1Polarity; /*!< Specifies the active edge of the input signal.
                          This parameter can be a value of @ref TIM_Encoder_Input_Polarity */

    uint32_t
        IC1Selection; /*!< Specifies the input.
                           This parameter can be a value of @ref TIM_Input_Capture_Selection */
    ...
    uint32_t
        IC2Polarity; /*!< Specifies the active edge of the input signal.
                          This parameter can be a value of @ref TIM_Encoder_Input_Polarity */

    uint32_t
        IC2Selection; /*!< Specifies the input.
                          This parameter can be a value of @ref TIM_Input_Capture_Selection */

    uint32_t
        IC2Prescaler; /*!< Specifies the Input Capture Prescaler.
                           This parameter can be a value of @ref TIM_Input_Capture_Prescaler */
...
typedef struct {
    ...
    uint32_t
        ClockPolarity; /*!< TIM clock polarity
                            This parameter can be a value of @ref TIM_Clock_Polarity */
    uint32_t
        ClockPrescaler; /*!< TIM clock prescaler
                             This parameter can be a value of @ref TIM_Clock_Prescaler */
    uint32_t
        ClockFilter; /*!< TIM clock filter
                          This parameter can be a number between Min_Data = 0x0 and Max_Data = 0xF */
...
typedef struct {
    ...
    uint32_t
        ClearInputSource; /*!< TIM clear Input sources
    ...
    uint32_t
        ClearInputFilter; /*!< TIM Clear Input filter
                               This parameter can be a number between Min_Data = 0x0 and Max_Data = 0xF */
...
typedef struct {
    ...
    uint32_t
        MasterOutputTrigger2; /*!< Trigger output2 (TRGO2) selection
...
typedef struct {
    ...
    uint32_t
        InputTrigger; /*!< Input Trigger source
                           This parameter can be a value of @ref TIM_Trigger_Selection */
    uint32_t
        TriggerPolarity; /*!< Input Trigger polarity
                              This parameter can be a value of @ref TIM_Trigger_Polarity */
    uint32_t
        TriggerPrescaler; /*!< Input trigger prescaler
                               This parameter can be a value of @ref TIM_Trigger_Prescaler */
    uint32_t
        TriggerFilter; /*!< Input trigger filter
                            This parameter can be a number between Min_Data = 0x0 and Max_Data = 0xF  */
...
typedef struct {
    ...
    uint32_t
        OffStateIDLEMode; /*!< TIM off state in IDLE mode, This parameter can be a value of @ref TIM_OSSI_Off_State_Selection_for_Idle_mode_state */

    uint32_t
        LockLevel; /*!< TIM Lock level, This parameter can be a value of @ref TIM_Lock_level */

    uint32_t
        DeadTime; /*!< TIM dead Time, This parameter can be a number between Min_Data = 0x00 and Max_Data = 0xFF */

    uint32_t
        BreakState; /*!< TIM Break State, This parameter can be a value of @ref TIM_Break_Input_enable_disable */

    uint32_t
        BreakPolarity; /*!< TIM Break input polarity, This parameter can be a value of @ref TIM_Break_Polarity */

    uint32_t
        BreakFilter; /*!< Specifies the break input filter.This parameter can be a number between Min_Data = 0x0 and Max_Data = 0xF */

    uint32_t
        Break2State; /*!< TIM Break2 State, This parameter can be a value of @ref TIM_Break2_Input_enable_disable */

    uint32_t
        Break2Polarity; /*!< TIM Break2 input polarity, This parameter can be a value of @ref TIM_Break2_Polarity */

    uint32_t
        Break2Filter; /*!< TIM break2 input filter.This parameter can be a number between Min_Data = 0x0 and Max_Data = 0xF */

    uint32_t
        AutomaticOutput; /*!< TIM Automatic Output Enable state, This parameter can be a value of @ref TIM_AOE_Bit_Set_Reset */
...
typedef enum {
    ...
    HAL_TIM_STATE_BUSY =
        0x02U, /*!< An internal process is ongoing              */
    HAL_TIM_STATE_TIMEOUT =
        0x03U, /*!< Timeout state                               */
    HAL_TIM_STATE_ERROR =
        0x04U /*!< Reception process is ongoing                */
...
typedef enum {
    HAL_TIM_CHANNEL_STATE_RESET =
        0x00U, /*!< TIM Channel initial state                         */
    HAL_TIM_CHANNEL_STATE_READY =
        0x01U, /*!< TIM Channel ready for use                         */
...
#endif /* USE_HAL_TIM_REGISTER_CALLBACKS */
{
    ...
    __IO HAL_TIM_ChannelStateTypeDef ChannelState
        [6]; /*!< TIM channel operation state                       */
    __IO HAL_TIM_ChannelStateTypeDef ChannelNState
        [4]; /*!< TIM complementary channel operation state         */
    ...
    void (*Base_MspInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM Base Msp Init Callback                              */
    void (*Base_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM Base Msp DeInit Callback                            */
    void (*IC_MspInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM IC Msp Init Callback                                */
    void (*IC_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM IC Msp DeInit Callback                              */
    void (*OC_MspInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM OC Msp Init Callback                                */
    void (*OC_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM OC Msp DeInit Callback                              */
    void (*PWM_MspInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM PWM Msp Init Callback                               */
    void (*PWM_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM PWM Msp DeInit Callback                             */
    void (*OnePulse_MspInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM One Pulse Msp Init Callback                         */
    void (*OnePulse_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM One Pulse Msp DeInit Callback                       */
    void (*Encoder_MspInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM Encoder Msp Init Callback                           */
    void (*Encoder_MspDeInitCallback)(
        struct __TIM_HandleTypeDef *
            htim); /*!< TIM Encoder Msp DeInit Callback                         */
...
typedef enum {
    HAL_TIM_BASE_MSPINIT_CB_ID =
        0x00U /*!< TIM Base MspInit Callback ID                              */
    ,
    HAL_TIM_BASE_MSPDEINIT_CB_ID =
        0x01U /*!< TIM Base MspDeInit Callback ID                            */
    ,
    HAL_TIM_IC_MSPINIT_CB_ID =
        0x02U /*!< TIM IC MspInit Callback ID                                */
    ,
    HAL_TIM_IC_MSPDEINIT_CB_ID =
        0x03U /*!< TIM IC MspDeInit Callback ID                              */
    ,
    HAL_TIM_OC_MSPINIT_CB_ID =
        0x04U /*!< TIM OC MspInit Callback ID                                */
    ,
    HAL_TIM_OC_MSPDEINIT_CB_ID =
        0x05U /*!< TIM OC MspDeInit Callback ID                              */
    ,
    HAL_TIM_PWM_MSPINIT_CB_ID =
        0x06U /*!< TIM PWM MspInit Callback ID                               */
    ,
    HAL_TIM_PWM_MSPDEINIT_CB_ID =
        0x07U /*!< TIM PWM MspDeInit Callback ID                             */
    ,
    ...
    HAL_TIM_ENCODER_MSPINIT_CB_ID =
        0x0AU /*!< TIM Encoder MspInit Callback ID                           */
    ,
    ...
    HAL_TIM_IC_CAPTURE_CB_ID =
        0x12U /*!< TIM Input Capture Callback ID                              */
    ,
...
#define TIM_ENCODERMODE_TI12                                                   \
    (TIM_SMCR_SMS_1 |                                                          \
     TIM_SMCR_SMS_0) /*!< Quadrature encoder mode 3, x4 mode, counts up/down on both TI1FP1 and TI2FP2 edges depending on the level of the other input. */
/**
 * @}
 */
...
#define TIM_COMMUTATION_TRGI                                                   \
    TIM_CR2_CCUS /*!< When Capture/compare control bits are preloaded, they are updated by setting the COMG bit or when an rising edge occurs on trigger input */
...
#define TIM_AUTOMATICOUTPUT_ENABLE                                             \
    TIM_BDTR_AOE /*!< MOE can be set by software or automatically at the next update event (if none of the break inputs BRK and BRK2 is active) */
/**
 * @}
 */
...
#define TIM_OCMODE_FORCED_ACTIVE                                               \
    (TIM_CCMR1_OC1M_2 |                                                        \
     TIM_CCMR1_OC1M_0) /*!< Force active level                     */
...
#define TIM_OCMODE_RETRIGERRABLE_OPM2                                          \
    (TIM_CCMR1_OC1M_3 |                                                        \
     TIM_CCMR1_OC1M_0) /*!< Retrigerrable OPM mode 2               */
#define TIM_OCMODE_COMBINED_PWM1                                               \
    (TIM_CCMR1_OC1M_3 |                                                        \
     TIM_CCMR1_OC1M_2) /*!< Combined PWM mode 1                    */
...
#define TIM_TS_ITR3                                                            \
    (TIM_SMCR_TS_0 |                                                           \
     TIM_SMCR_TS_1) /*!< Internal Trigger 3 (ITR3)              */
#define TIM_TS_TI1F_ED                                                         \
    TIM_SMCR_TS_2 /*!< TI1 Edge Detector (TI1F_ED)            */
#define TIM_TS_TI1FP1                                                          \
    (TIM_SMCR_TS_0 |                                                           \
     TIM_SMCR_TS_2) /*!< Filtered Timer Input 1 (TI1FP1)        */
#define TIM_TS_TI2FP2                                                          \
    (TIM_SMCR_TS_1 |                                                           \
     TIM_SMCR_TS_2) /*!< Filtered Timer Input 2 (TI2FP2)        */
#define TIM_TS_ETRF                                                            \
...
#define TIM_BREAK_SYSTEM_ECC                                                   \
    SYSCFG_CFGR2_ECCL /*!< Enables and locks the ECC error signal with Break Input of TIM1/8/15/16/17 */
#define TIM_BREAK_SYSTEM_PVD                                                   \
    SYSCFG_CFGR2_PVDL /*!< Enables and locks the PVD connection with TIM1/8/15/16/17 Break Input and also the PVDE and PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_SRAM2_PARITY_ERROR                                    \
    SYSCFG_CFGR2_SPL /*!< Enables and locks the SRAM2_PARITY error signal with Break Input of TIM1/8/15/16/17 */
#define TIM_BREAK_SYSTEM_LOCKUP                                                \
    SYSCFG_CFGR2_CLL /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of TIM1/8/15/16/17 */
/**
 * @}
 */
...
#define IS_TIM_DMA_BASE(__BASE__)                                              \
    (((__BASE__) == TIM_DMABASE_CR1) || ((__BASE__) == TIM_DMABASE_CR2) ||     \
     ...
     ((__BASE__) == TIM_DMABASE_OR1) || ((__BASE__) == TIM_DMABASE_CCMR3) ||   \
     ((__BASE__) == TIM_DMABASE_CCR5) || ((__BASE__) == TIM_DMABASE_CCR6) ||   \
     ((__BASE__) == TIM_DMABASE_OR2) || ((__BASE__) == TIM_DMABASE_OR3))
