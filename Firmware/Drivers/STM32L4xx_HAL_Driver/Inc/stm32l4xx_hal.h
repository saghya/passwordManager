...
#define SYSCFG_BOOT_OCTOPSPI2                                                  \
    (SYSCFG_MEMRMP_MEM_MODE_2 | SYSCFG_MEMRMP_MEM_MODE_0)
#else
 ...
 * @{
 */
#define SYSCFG_SRAM2WRP_PAGE0                                                  \
    SYSCFG_SWPR_PAGE0 /*!< SRAM2 Write protection page 0 */
#define SYSCFG_SRAM2WRP_PAGE1                                                  \
...
#define SYSCFG_VREFBUF_VOLTAGE_SCALE0                                          \
    0U /*!< Voltage reference scale 0 (VREF_OUT1) */
...
#define SYSCFG_VREFBUF_HIGH_IMPEDANCE_DISABLE                                  \
    0U /*!< VREF_plus pin is internally connected to Voltage reference buffer output */
...
#define __HAL_DBGMCU_FREEZE_CAN1()                                             \
    SET_BIT(DBGMCU->APB1FZR1, DBGMCU_APB1FZR1_DBG_CAN_STOP)
...
#define __HAL_DBGMCU_FREEZE_CAN2()                                             \
    SET_BIT(DBGMCU->APB1FZR1, DBGMCU_APB1FZR1_DBG_CAN2_STOP)
#define __HAL_DBGMCU_UNFREEZE_CAN2()                                           \
    CLEAR_BIT(DBGMCU->APB1FZR1, DBGMCU_APB1FZR1_DBG_CAN2_STOP)
#endif
...
#define __HAL_DBGMCU_FREEZE_LPTIM2()                                           \
    SET_BIT(DBGMCU->APB1FZR2, DBGMCU_APB1FZR2_DBG_LPTIM2_STOP)
#define __HAL_DBGMCU_UNFREEZE_LPTIM2()                                         \
    CLEAR_BIT(DBGMCU->APB1FZR2, DBGMCU_APB1FZR2_DBG_LPTIM2_STOP)
#endif
 ...
 */
#define __HAL_SYSCFG_REMAPMEMORY_OCTOSPI1()                                    \
    MODIFY_REG(SYSCFG->MEMRMP, SYSCFG_MEMRMP_MEM_MODE,                         \
               (SYSCFG_MEMRMP_MEM_MODE_2))
#define __HAL_SYSCFG_REMAPMEMORY_OCTOSPI2()                                    \
    MODIFY_REG(SYSCFG->MEMRMP, SYSCFG_MEMRMP_MEM_MODE,                         \
               (SYSCFG_MEMRMP_MEM_MODE_2 | SYSCFG_MEMRMP_MEM_MODE_0))
 ...
 *         Enable and lock the SRAM2 parity error signal connection to
 * TIM1/8/15/16/17 Break input.
...
#define __HAL_SYSCFG_GET_FLAG(__FLAG__)                                        \
    ((((((__FLAG__) == SYSCFG_SCSR_SRAM2BSY) ? SYSCFG->SCSR : SYSCFG->CFGR2) & \
       (__FLAG__)) != 0U)                                                      \
         ? 1U                                                                  \
         : 0U)
...
#define IS_SYSCFG_SRAM2WRP_PAGE(__PAGE__)                                      \
    (((__PAGE__) > 0U) && ((__PAGE__) <= 0xFFFFFFFFUL))
