...
#define COMP_LPTIMCONNECTION_ENABLED                                           \
    ((uint32_t)0x00000003U) /*!< COMPX output generic naming: connected to LPTIM input 1 for COMP1, LPTIM input 2 for COMP2 */
#endif
...
#define HAL_CRC_Input_Data_Reverse                                             \
    HAL_CRCEx_Input_Data_Reverse /*!< Aliased to HAL_CRCEx_Input_Data_Reverse for inter STM32 series compatibility  */
#define HAL_CRC_Output_Data_Reverse                                            \
    HAL_CRCEx_Output_Data_Reverse /*!< Aliased to HAL_CRCEx_Output_Data_Reverse for inter STM32 series compatibility */
...
#define ETH_MAC_TRANSMITFRAMECONTROLLER_GENRATING_PCF                          \
    0x00040000U /* MAC transmit frame controller: Generating and transmitting  \
                   a Pause control frame (in full duplex mode) */
...
#define HAL_VREFINT_Cmd(cmd)                                                   \
    (((cmd) == ENABLE) ? HAL_SYSCFG_EnableVREFINT()                            \
                       : HAL_SYSCFG_DisableVREFINT())
#endif
