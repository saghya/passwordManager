                    ...
                    switch (pdev->dev_state) {
                        ...
                        case USBD_STATE_CONFIGURED:
                            if (req->wValue == USB_FEATURE_EP_HALT) {
                                ...
                                (void)USBD_CtlSendStatus(pdev);
                                ret = (USBD_StatusTypeDef)pdev->pClass->Setup(
                                    pdev, req);
                            }
                            break;
                    ...
                    switch (pdev->dev_state) {
                        ...
                        case USBD_STATE_CONFIGURED:
                            if ((ep_addr & 0x80U) == 0x80U) {
                                ...
                                if (pdev->ep_out[ep_addr & 0xFU].is_used ==
                                    0U) {
                                    USBD_CtlError(pdev, req);
                                    break;
                                }
            ...
            switch ((uint8_t)(req->wValue)) {
                ...
                case USBD_IDX_SERIAL_STR:
                    if (pdev->pDesc->GetSerialStrDescriptor != NULL) {
                        pbuf = pdev->pDesc->GetSerialStrDescriptor(
                            pdev->dev_speed, &len);
                    } else {
                        USBD_CtlError(pdev, req);
                        err++;
                ...
                case USBD_IDX_INTERFACE_STR:
                    if (pdev->pDesc->GetInterfaceStrDescriptor != NULL) {
                        pbuf = pdev->pDesc->GetInterfaceStrDescriptor(
                            pdev->dev_speed, &len);
                    } else {
                        USBD_CtlError(pdev, req);
                        err++;
                ...
                default:
                    ...
                    if (pdev->pClass->GetUsrStrDescriptor != NULL) {
                        pbuf = pdev->pClass->GetUsrStrDescriptor(
                            pdev, (req->wValue), &len);
                    } else {
                        USBD_CtlError(pdev, req);
                        err++;
                    ...
                    if (pdev->pDesc->GetUserStrDescriptor != NULL) {
                        pbuf = pdev->pDesc->GetUserStrDescriptor(
                            pdev->dev_speed, (req->wValue), &len);
                    } else {
                        USBD_CtlError(pdev, req);
                        err++;
                    }
        ...
        switch (pdev->dev_state) {
            ...
            case USBD_STATE_ADDRESSED:
                ...
                (void)USBD_CtlSendData(
                    pdev, (uint8_t *)&pdev->dev_default_config, 1U);
                break;
...
static void USBD_GetStatus(USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req)
{
    switch (pdev->dev_state) {
        ...
        case USBD_STATE_CONFIGURED:
            ...
            (void)USBD_CtlSendData(pdev, (uint8_t *)&pdev->dev_config_status,
                                   2U);
            break;
